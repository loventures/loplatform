...
public interface AttachmentParentFacade extends Facade {
    ...
    /**
     * add *Component doesn't work yet.  If you need this method, use service.attachment.AttachmentParentFacade
     */
    // public AttachmentComponent addAttachment(UploadInfo upload); // fail sauce
}
