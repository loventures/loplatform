...
@Controller(value="taskReports", root=true)
public interface TaskReportApiRoot extends ApiRootComponent {

    @RequestMapping(path = "taskReports/{identifier}", method = Method.GET)
    Optional<TaskReport> getTaskReport(@PathVariable("identifier") final String identifier);
