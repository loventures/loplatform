...
public interface IntegrationRootOwner extends ComponentInterface {
    @RequestMapping(path = "integrations")
    @Secured(value = AdminRight.class, match = RightMatch.ANY)
    public default IntegrationRootComponent getIntegrationRoot() {
