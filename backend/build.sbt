...
ThisBuild / dependencyOverrides += "io.netty" % "netty-codec-http2"             % "4.2.7.Final"
ThisBuild / dependencyOverrides += "io.netty" % "netty-codec"                   % "4.2.7.Final"
ThisBuild / dependencyOverrides += "io.netty" % "netty-handler"                 % "4.2.7.Final"
ThisBuild / dependencyOverrides += "io.netty" % "netty-transport-classes-epoll" % "4.2.7.Final"
