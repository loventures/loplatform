...
public class EmptySequencedMethodScope implements SequencedMethodScope {

    public static final EmptySequencedMethodScope INSTANCE = new EmptySequencedMethodScope();
