...
@Bound(value = ServletBinding.class)
@Instrument
public interface ServletComponent extends ComponentInterface {
    @Required
    WebResponse service(HttpServletRequest request, HttpServletResponse response) throws Exception;
}
