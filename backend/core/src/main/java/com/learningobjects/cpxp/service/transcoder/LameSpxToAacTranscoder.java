...
public class LameSpxToAacTranscoder  implements AudioTranscoder {
    private static final Logger logger = Logger.getLogger(LameSpxToAacTranscoder.class.getName());
    ...
    //command requires OGG123 bins and FAAC bin to be installed
    ...
    public void transcode(InputStream srcStream, String destFilePath) throws AudioTranscoderException {
        ...
        try {
            ...
            tmpf.deleteOnExit();
            FileUtils.copyInputStreamToFile(srcStream, tmpf);
