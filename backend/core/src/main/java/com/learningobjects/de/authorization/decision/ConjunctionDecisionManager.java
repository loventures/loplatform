...
/**
 * Requires all voters vote yes to grant access.
 */
public class ConjunctionDecisionManager implements AccessDecisionManager {

    private final List<AccessDecisionVoter> voters;

    public ConjunctionDecisionManager(final List<AccessDecisionVoter> voters) {
