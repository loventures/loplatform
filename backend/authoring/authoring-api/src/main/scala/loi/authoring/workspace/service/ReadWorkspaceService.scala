...
package loi.authoring.workspace.service
...
trait ReadWorkspaceService:
  ...
  def loadReadWorkspaceFromCommit(commitId: Long): Option[ReadWorkspace]

  def requireDetachedWorkspace(commitId: Long): ReadWorkspace
