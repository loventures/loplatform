...
final case class ObservationAssessment1(
  @Size(min = 1, max = 255)
  title: String,
  iconAlt: String = "",
  @Size(min = 0, max = 255)
...
object ObservationAssessment1:

  implicit val assetTypeForObservationAssessment1: AssetType[ObservationAssessment1] =
    new AssetType[ObservationAssessment1](AssetTypeId.ObservationAssessment):
      ...
      override def validate(data: ObservationAssessment1): ValidatedNel[String, Unit] =
      ...
      override def edgeIds(data: ObservationAssessment1): Set[UUID] = data.instructions.edgeIds

      override def render(
        data: ObservationAssessment1,
        targets: Map[UUID, Asset[?]]
      ): ObservationAssessment1 =
        data.copy(instructions = data.instructions.render(targets))
  ...
  object Asset extends AssetExtractor[ObservationAssessment1]
end ObservationAssessment1
