...
@Entity
@Table(name = "assetexportreceipt", indexes = {
  @Index(name = "assetexportreceipt_root_idx", columnList = "root_id")
})
@Cache(usage = READ_WRITE)
public class ExportReceiptEntity {
    ...
    public ExportReceiptEntity(final Long id, final JsonNode data, final JsonNode source, final JsonNode report,
                               final Long attachmentId, final String status, final Date createTime,
                               final Date startTime, final Date endTime, final Long createdBy, final Long root) {
        this.id = id;
        this.data = data;
        this.source = source;
        this.report = report;
