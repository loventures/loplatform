...
case class EvidenceEvent(
  id: UUID,
  time: Date,
  source: String,
  user: ExternallyIdentifiableEntity,
  evidenceId: Long,
  evidenceSourceId: Option[String],
  evidenceSourceType: Option[String],
  evidenceType: Option[String],
  evidenceSequenceNumber: Long,
  evidencePointsAwarded: Double,
  evidencePointsPossible: Double,
  competencyId: Long,
  competencyGuid: UUID,
  ...
  override val sessionId: Option[Long] = None
  override val actionType              = EventActionType.GENERATE
end EvidenceEvent
