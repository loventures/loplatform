...
(function () {
          ...
          on: function (b, c, l, h, k) {
            ...
            if (0 > z.getListenerIndex(c)) {
              ...
              for (var x = z.length - 1; 0 <= x; x--)
                if (z[x].priority <= k) return z.splice(x + 1, 0, p), { removeListener: f };
              z.unshift(p);
            }
          ...
          fire: (function () {
            ...
            return function (k, p, f) {
              ...
              if (y) {
                var x = y.listeners;
                if (x.length)
                  for (var x = x.slice(0), C, v = 0; v < x.length; v++) {
                    if (y.errorProof)
                      try {
  ...
  (function () {
    ...
    var b = [],
      ...
      p = { lt: '\x3c', gt: '\x3e', amp: '\x26', quot: '"', nbsp: ' ', shy: '­' },
      f = function (a, z) {
    ...
    CKEDITOR.tools = {
      ...
      extend: function (a) {
        ...
        'boolean' == typeof (c = arguments[b - 1])
          ? b--
          : 'boolean' == typeof (c = arguments[b - 2]) && ((f = arguments[b - 1]), (b -= 2));
        for (var h = 1; h < b; h++) {
          var n = arguments[h] || {};
        ...
        for (var b, c = [], f = 0; f < a.length; f++)
          if ((b = a[f]))
            /@import|[{}]/.test(b)
              ...
              : c.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e');
        return c.join('');
      },
      htmlEncode: function (a) {
        return void 0 === a || null === a
          ? ''
          : String(a).replace(g, '\x26amp;').replace(e, '\x26gt;').replace(l, '\x26lt;');
      },
      htmlDecode: function (a) {
        return a.replace(k, f);
      },
      ...
      transformPlainTextToHtml: function (a, b) {
        ...
        f = f.replace(/\n/g, '\x3cbr\x3e');
        c ||
          (f = f.replace(new RegExp('\x3cbr\x3e(?\x3d\x3c/' + h + '\x3e)'), function (a) {
      ...
      parseCssText: function (a, b, c) {
        ...
        c &&
          (a =
            new CKEDITOR.dom.element('span').setAttribute('style', a).getAttribute('style') || '');
        ...
        a.replace(/&quot;/g, '"').replace(
          ...
          function (a, c, y) {
            b &&
              ((c = c.toLowerCase()),
              'font-family' == c && (y = y.replace(/\s*,\s*/g, ',')),
              (y = CKEDITOR.tools.trim(y)));
            f[c] = y;
          }
        );
        return f;
      ...
      enableHtml5Elements: function (a, b) {
        for (
          ...
          (h = a.createElement(c[f])), b && a.appendChild(h);
      },
      ...
      keystrokeToArray: function (a, b) {
        ...
        f &&
          (a[f]
            ? (n.push(a[f]), k.push(a[f]))
            : (n.push(String.fromCharCode(f)), k.push(String.fromCharCode(f))));
      ...
      getCookie: function (a) {
        ...
        for (var b = document.cookie.split(';'), c, f, h = 0; h < b.length; h++)
          if (
            ((c = b[h].split('\x3d')),
            (f = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase())),
            f === a)
          )
      ...
      getCsrfToken: function () {
        ...
        if (!a || 40 != a.length) {
          ...
          for (c = 0; c < a.length; c++)
            var f = 'abcdefghijklmnopqrstuvwxyz0123456789'.charAt(a[c] % 36),
              b = b + (0.5 < Math.random() ? f.toUpperCase() : f);
          a = b;
      ...
      escapeCss: function (a) {
        if (a)
          if (window.CSS && CSS.escape) a = CSS.escape(a);
            ...
            a = String(a);
            for (var b = a.length, c = -1, f, h = '', n = a.charCodeAt(0); ++c < b; )
              (f = a.charCodeAt(c)),
                (h =
                  0 == f
                    ? h + '�'
        ...
        for (f = 0; f < c; f += 3) {
          ...
          for (d = 0; 4 > d; d++)
            b =
              d <= n
                ? b +
                  'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(k[d])
                : b + '\x3d';
        }
        return b;
      },
        ...
        parse: {
          ...
          margin: function (a) {
            return CKEDITOR.tools.style.parse.sideShorthand(a, function (a) {
              return (
                a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset|revert)/g) || ['0px']
              );
            });
          },
      ...
      object: {
        ...
        merge: function (a, b) {
          ...
          c.array.forEach(c.object.keys(h), function (a) {
            f[a] =
              'object' === typeof h[a] && 'object' === typeof f[a]
                ? c.object.merge(f[a], h[a])
                : h[a];
          });
          return f;
        },
      ...
      statics: {
        fromCssRule: function (a) {
          ...
          CKEDITOR.tools.array.forEach(c, function (a) {
            b.style || -1 === CKEDITOR.tools.indexOf(CKEDITOR.tools.style.parse._borderStyle, a)
              ? !b.width && CKEDITOR.tools.style.parse._widthRegExp.test(a) && (b.width = a)
              : (b.style = a);
          });
  ...
  (function (a) {
    ...
    a.getUniqueId = function () {
      return (
        this.$['data-cke-expando'] || (this.$['data-cke-expando'] = CKEDITOR.tools.getNextNumber())
      );
    };
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getIndex: function (a) {
      ...
      if (
        ...
        return -1;
      do
        if (!a || b.equals(this) || b.type != CKEDITOR.NODE_TEXT || (!g && !b.isEmpty()))
          c++, (g = b.type == CKEDITOR.NODE_TEXT);
    ...
    rtrim: function () {
      for (var a; this.getLast && (a = this.getLast()); ) {
        if (a.type == CKEDITOR.NODE_TEXT) {
          ...
          if (d)
            d.length < b &&
              (a.split(d.length), this.$.lastChild.parentNode.removeChild(this.$.lastChild));
          else {
            a.remove();
            continue;
          }
  ...
  (function () {
    ...
    function c(a) {
      for (var b = 0, c = 0, f = l[a].length; c < f; c++)
        b += parseFloat(this.getComputedStyle(l[a][c]) || 0, 10) || 0;
      return b;
    }
    var g = document.createElement('_').classList,
      g = 'undefined' !== typeof g && null !== String(g.add).match(/\[Native code\]/gi),
      e = /[\n\t\r]/g;
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      breakParent: function (a, b) {
        ...
        if (CKEDITOR.env.ie && !CKEDITOR.env.edge) {
          for (c = new CKEDITOR.dom.element('div'); (d = f.getFirst()); )
            d.$.style.backgroundColor && (d.$.style.backgroundColor = d.$.style.backgroundColor),
              c.append(d);
          c.insertAfter(this);
          c.remove(!0);
      ...
      removeStyle: function (a) {
        ...
        if (b.removeProperty || ('border' != a && 'margin' != a && 'padding' != a))
          ...
          for (var b = [], d = 0; d < c.length; d++)
            if (f) for (var e = 0; e < f.length; e++) b.push([a, c[d], f[e]].join('-'));
      ...
      setOpacity: function (a) {
        CKEDITOR.env.ie && 9 > CKEDITOR.env.version
          ? ((a = Math.round(100 * a)),
            this.setStyle(
              'filter',
              100 <= a ? '' : 'progid:DXImageTransform.Microsoft.Alpha(opacity\x3d' + a + ')'
            ))
        ...
        if (
          ...
          H &&
            (CKEDITOR.env.webkit || (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ? ((b = d.$.scrollLeft || l.scrollLeft), (c = d.$.scrollTop || l.scrollTop))
              : ((c = e ? d.$ : l), (b = c.scrollLeft), (c = c.scrollTop)),
            (b = g.left + b - n),
            (c = g.top + c - v));
        } else
          for (v = this, n = null; v && 'body' != v.getName() && 'html' != v.getName(); ) {
            b += v.$.offsetLeft - v.$.scrollLeft;
            c += v.$.offsetTop - v.$.scrollTop;
            v.equals(this) || ((b += v.$.clientLeft || 0), (c += v.$.clientTop || 0));
            for (; n && !n.equals(v); )
              (b -= n.$.scrollLeft), (c -= n.$.scrollTop), (n = n.getParent());
            n = v;
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        function v(a, b) {
          ...
          f = a.getWindow();
          f.equals(b) ||
            ((f = v(CKEDITOR.dom.element.get(f.$.frameElement), b)), (c.x += f.x), (c.y += f.y));
          return c;
        }
        function n(a, b) {
        ...
        for (var f = 0; f < c.length; f++) {
          ...
          if (!(e in b))
            if ('checked' == e && (g = this.getAttribute(e))) a.setAttribute(e, g);
              ...
              (g = this.getAttribute(e)), null === g && (g = d.nodeValue), a.setAttribute(e, g);
        }
      ...
      getEditor: function (a) {
        ...
        for (c in b)
          if (
            ((f = b[c]),
            (f.element.equals(this) && f.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) ||
      ...
      isDetached: function () {
        ...
        return b.equals(this) || b.contains(this)
          ? !CKEDITOR.env.ie || (8 < CKEDITOR.env.version && !CKEDITOR.env.quirks)
            ? !a.$.defaultView
            : !1
          : !0;
      },
  ...
  (function () {
            ...
            ? f.type == CKEDITOR.NODE_ELEMENT &&
              (f =
                0 < g
                  ...
                  : !1 === h(f, !0)
                    ? null
                    : f.getPreviousSourceNode(!0, m, h))
            : ((f = d),
              f.type == CKEDITOR.NODE_ELEMENT &&
                ((f = f.getChild(e)) ||
                  (f = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, m, h)))),
          f && !1 === h(f) && (f = null));
      for (; f && !this._.end; ) {
        this.current = f;
      ...
      return function (b) {
        ...
        b &&
          ...
          (c =
            ...
            (CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE));
        return !!(a ^ c);
      };
    };
    CKEDITOR.dom.walker.invisible = function (a) {
      ...
      return function (f) {
        b(f)
          ? (f = 1)
          : (f.type == CKEDITOR.NODE_TEXT && (f = f.getParent()), (f = f.$.offsetWidth <= c));
        return !!(a ^ f);
      };
    };
    ...
    var f = CKEDITOR.dom.walker.empty(),
      y = (CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(
        (function (a) {
          var b = {},
            c;
          ...
          : b.type == CKEDITOR.NODE_TEXT ||
              (b.type == CKEDITOR.NODE_ELEMENT &&
                (b.is(CKEDITOR.dtd.$inline) ||
                  ...
                  (!CKEDITOR.env.needsBrFiller && b.is(y) && f(b))))
            ? !0
            : !1;
        return !!(a ^ b);
      };
    ...
    CKEDITOR.dom.element.prototype.getBogus = function () {
      ...
      while (k(a));
      return a &&
        (CKEDITOR.env.needsBrFiller ? a.is && a.is('br') : a.getText && g.test(a.getText()))
        ? a
        : !1;
    };
  })();
  ...
  (function () {
    ...
    function d(a, b, c, d, e) {
      ...
      function h() {
        ...
        b < J - 1 || b < u - 1 || c
          ? (c
              ? a.moveToPosition(G, CKEDITOR.POSITION_BEFORE_START)
              : u == b + 1 && r
                ? a.moveToPosition(t[b], CKEDITOR.POSITION_BEFORE_END)
                : a.moveToPosition(t[b + 1], CKEDITOR.POSITION_BEFORE_START),
            d &&
              (b = S[b + 1]) &&
              b.type == CKEDITOR.NODE_ELEMENT &&
      ...
      if (
        ...
        (m.equals(G) || (m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(G)))
      )
        c.append(a.document.createText(G.substring(L, A)));
      else {
        G.type == CKEDITOR.NODE_TEXT
          ? k
            ? (Q = !0)
        ...
        for (
          ...
          aa = da.getNext();
          for (
            U != J || (da.equals(t[U]) && J < u)
              ? b && (D = B.append(da.clone(0, e)))
              : M
                ? g(da, B, !1, F)
                : w && B.append(a.document.createText(da.substring(L)));
            aa;
        ...
        for (U = O; U <= u; U++)
          if (((c = t[U]), (aa = c.getPrevious()), c.equals(S[U]))) b && (B = B.getChild(0));
            ...
            U != u || (c.equals(S[U]) && u < J)
              ? b && (D = B.append(c.clone(0, e)))
              : r
                ? g(c, B, !1, E)
                : Q && B.append(a.document.createText(c.substring(0, A)));
            if (U > fa) for (; aa; ) aa = g(aa, B, !0);
            B = D;
          }
        k || h();
      }
    ...
    function c(a) {
      ...
      return function (d) {
        return c(d) || b(d)
          ? !0
          : (!a && l(d)) || (d.type == CKEDITOR.NODE_ELEMENT && d.is(CKEDITOR.dtd.$removeEmpty));
      };
    }
    function g(a) {
      return function () {
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      collapse: function (a) {
        a
          ? (this._setEndContainer(this.startContainer), (this.endOffset = this.startOffset))
          : (this._setStartContainer(this.endContainer), (this.startOffset = this.endOffset));
        this.collapsed = !0;
      },
      ...
      createBookmark: function (a) {
        function b(a) {
          return a.getAscendant(function (a) {
            ...
            if ((b = a.data && a.data('cke-temp')))
              b =
                -1 ===
                CKEDITOR.tools.array.indexOf(['cke_copybin', 'cke_pastebin'], a.getAttribute('id'));
            return b;
          }, !0);
        }
        ...
        a &&
          ...
          g.setAttribute('id', h + (e ? 'C' : 'S')));
        e ||
          ((n = g.clone()),
          n.setHtml('\x26nbsp;'),
          a && n.setAttribute('id', h + 'E'),
          (l = this.clone()),
          b(d) && ((d = b(d)), l.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)),
          l.collapse(),
          l.insertNode(n));
        l = this.clone();
        ...
        l.insertNode(g);
        n
          ? (this.setStartAfter(g), this.setEndBefore(n))
      ...
      createBookmark2: (function () {
        ...
        function b(a, c) {
          ...
          if (f) {
            ...
            f.equals(d) &&
              ...
              0 >= a.offset && ((a.offset = d.getIndex()), (a.container = d.getParent())));
          }
        }
        ...
        return function (c) {
          ...
          c && (a(e), b(e, this.root), d || (a(n), b(n, this.root)));
          return {
      ...
      trim: function (a, b) {
        ...
        b ||
          ...
          (d ? (d >= c.getLength() || c.split(d), (d = c.getIndex() + 1)) : (d = c.getIndex()),
          (c = c.getParent()),
          this.setEnd(c, d));
      },
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            A.type == CKEDITOR.NODE_TEXT
              ? (r && ((A = !CKEDITOR.tools.trim(A.substring(0, r)).length && A), (L = !!A)),
                A && ((m = A.getPrevious()) || (k = A.getParent())))
              : (r && (m = A.getChild(r - 1) || A.getLast()), m || (k = A));
            for (k = c(k); k || m; ) {
              if (k && !m) {
                !G && k.equals(n) && (G = !0);
                if (e ? k.isBlockBoundary() : !h.contains(k)) break;
                (L && 'inline' == k.getComputedStyle('display')) ||
                  ((L = !1), G ? (l = k) : this.setStartBefore(k));
                m = k.getPrevious();
              }
              for (; m; )
                if (((A = !1), m.type == CKEDITOR.NODE_COMMENT)) m = m.getPrevious();
                  ...
                  if (m.type == CKEDITOR.NODE_TEXT)
                    (M = m.getText()), d.test(M) && (m = null), (A = /[\s\ufeff]$/.test(M));
                  else if (
                    (m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || (b && m.is('br'))) &&
                    !m.data('cke-bookmark')
                  )
            ...
            G = L = !1;
            A.type == CKEDITOR.NODE_TEXT
              ? CKEDITOR.tools.trim(A.substring(r)).length
                ? (L = !0)
                : ((L = !A.getLength()),
                  r == A.getLength()
                    ? (m = A.getNext()) || (k = A.getParent())
                    : g(A, r) && (k = A.getParent()))
              : (m = A.getChild(r)) || (k = A);
            for (; k || m; ) {
              if (k && !m) {
                ...
                if (e ? k.isBlockBoundary() : !h.contains(k)) break;
                (L && 'inline' == k.getComputedStyle('display')) ||
                  ((L = !1), G ? (p = k) : k && this.setEndAfter(k));
                m = k.getNext();
              }
              for (; m; ) {
                A = !1;
                if (m.type == CKEDITOR.NODE_TEXT)
                  (M = m.getText()), g(m, 0) || (m = null), (A = /^[\s\ufeff]/.test(M));
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            this.setStartAt(
              w,
              !w.is('br') && ((!k && this.checkStartOfBlock()) || (k && w.contains(k)))
            ...
            k = new CKEDITOR.dom.walker(k);
            k.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : O;
            w = t = Q = null;
            k = k.lastForward();
            w = w || h;
            this.setEndAt(
              w,
              (!k && this.checkEndOfBlock()) || (k && w.contains(k))
      ...
      shrink: function (a, b, c) {
        ...
        if (!this.collapsed) {
          ...
          g.evaluator = function (b) {
            return (
              b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT)
            );
          };
          var L;
          g.guard = function (b, c) {
            ...
            if (
              ...
              (c && b.equals(L)) ||
              (!1 === d && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary()) ||
          ...
          c &&
            (n = g[a == CKEDITOR.SHRINK_ELEMENT ? 'lastForward' : 'next']()) &&
            this.setStartAt(n, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
          p &&
            (g.reset(),
            (g = g[a == CKEDITOR.SHRINK_ELEMENT ? 'lastBackward' : 'previous']()) &&
              this.setEndAt(g, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
          return !(!c && !p);
        }
      },
      ...
      splitBlock: function (a, b) {
        ...
        e &&
          e.equals(g) &&
          (d
            ? ((n = new CKEDITOR.dom.elementPath(this.startContainer, this.root)),
              this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END),
              (g = null))
            : c
              ? ((n = new CKEDITOR.dom.elementPath(this.startContainer, this.root)),
                ...
                (e = null))
              : ((g = this.splitElement(e, b || !1)), e.is('ul', 'ol') || e.appendBogus()));
        return {
          previousBlock: e,
          nextBlock: g,
          wasStartOfBlock: c,
      ...
      checkStartOfBlock: function (a) {
        ...
        CKEDITOR.env.ie &&
          d &&
          c.type == CKEDITOR.NODE_TEXT &&
          ((c = CKEDITOR.tools.ltrim(c.substring(0, d))), h.test(c) && this.trim(0, 1));
        a || this.trim();
      ...
      checkEndOfBlock: function (a) {
        ...
        CKEDITOR.env.ie &&
          c.type == CKEDITOR.NODE_TEXT &&
          ((c = CKEDITOR.tools.rtrim(c.substring(d))), h.test(c) && this.trim(1, 0));
        a || this.trim();
      ...
      moveToClosestEditablePosition: function (a, b) {
        var c,
          ...
          e,
          g,
          n = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
        a
          ? ((c = new CKEDITOR.dom.range(this.root)), c.moveToPosition(a, n[b ? 0 : 1]))
          : (c = this.clone());
      ...
      getClientRects: (function () {
        function a(b, c) {
          ...
          c.startContainer instanceof CKEDITOR.dom.element &&
            (g = 0 === c.startOffset && c.startContainer.hasAttribute('data-widget'));
            ...
            (h =
              (h =
                ...
                (c.endContainer.getChildCount
                  ? c.endContainer.getChildCount()
                  : c.endContainer.length)) && c.endContainer.hasAttribute('data-widget'));
              ...
              ? ((a = e.checkStartOfBlock()),
                ...
                a
                  ...
                  : 0 === e.startOffset
                    ...
                    : ((e = e.startContainer.getChildren().getItem(e.startOffset - 1)),
                      f.insertAfter(e)),
                c.setStart(f.$, 0),
                c.setEnd(f.$, 0),
                (a = c.getClientRects()),
      ...
      _find: function (a, b) {
        ...
        if (c && c.find)
          for (n = c.find(a), g = 0; g < n.count(); g++)
            if (((c = n.getItem(g)), b || !c.isReadOnly()))
              (h =
                c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c)),
                (l =
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          v.enlarge(
            (this.forceBrBreak && !l) || !this.enlargeBr
              ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS
              : CKEDITOR.ENLARGE_BLOCK_CONTENTS
          );
          v.collapsed ||
            ((l = new CKEDITOR.dom.walker(v.clone())),
            (n = CKEDITOR.dom.walker.bookmark(!0, !0)),
            (l.evaluator = n),
            (this._.nextNode = l.next()),
            (l = new CKEDITOR.dom.walker(v.clone())),
            (l.evaluator = n),
            (l = l.previous()),
            (this._.lastNode = l.getNextSourceNode(!0, null, v.root)),
            this._.lastNode &&
              ...
              n.checkEndOfBlock() &&
                ...
                (this._.lastNode = (n.block || n.blockLimit).getNextSourceNode(!0)))),
            (this._.lastNode && v.root.contains(this._.lastNode)) ||
              ((this._.lastNode = this._.docEndMarker = v.document.createText('')),
        ...
        for (this._.nextNode = null; n; ) {
          ...
          if (I) n.type == CKEDITOR.NODE_TEXT && g.test(n.getText()) && (I = 0);
            ...
            if (CKEDITOR.dtd.$block[m] && 'false' == n.getAttribute('contenteditable')) {
              ...
              l &&
                (l.setEndAt(n, CKEDITOR.POSITION_BEFORE_START), 'br' != m && (this._.nextNode = n));
              H = 1;
            } else {
              if (n.getFirst()) {
        ...
        if (!d) {
          ...
          !n.equals(l.root)
            ? (d = n)
            : !d || (this.enforceRealBlocks && d.is(k))
              ? ((d = this.range.document.createElement(a)),
                ...
                (x = C = !0))
              : 'li' != d.getName()
                ? (l.checkStartOfBlock() && l.checkEndOfBlock()) ||
                  ((d = d.clone(!1)),
                  l.extractContents().appendTo(d),
                  d.trim(),
                  (C = l.splitBlock()),
                ...
                : z ||
                  (this._.nextNode = d.equals(v)
                    ? null
                    : this._getNextSourceNode(l.getBoundaryNodes().endNode, 1, v));
        }
        x &&
          (x = d.getPrevious()) &&
          ...
          ('br' == x.getName()
            ? x.remove()
            : x.getLast() && 'br' == x.getLast().$.nodeName.toLowerCase() && x.getLast().remove());
        C &&
          (x = d.getLast()) &&
          x.type == CKEDITOR.NODE_ELEMENT &&
          'br' == x.getName() &&
          (!CKEDITOR.env.needsBrFiller || x.getPrevious(e) || x.getNext(e)) &&
          x.remove();
        this._.nextNode ||
          (this._.nextNode = z || d.equals(v) || !v ? null : this._getNextSourceNode(d, 1, v));
        return d;
      },
  ...
  (function () {
    function a(a, b, c, d, e) {
      ...
      for (f in b) {
        ...
        for (r in Q) {
          ...
          for (; (O = w.pop()); ) (n[O] = n['!' + O]), delete n['!' + O];
          E[t] = (B ? !1 : h) || null;
        }
      ...
      for (d = a.length; c < d; ++c) {
        ...
        if (!0 === f.elements || null === f.elements) e[g ? 'unshift' : 'push'](f);
        else
          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var f = 0, g = c.length, m; f < g; ++f) (m = c[f]), e[m] || (e[m] = a(m));
                a = !1;
              }
            else a = !1;
            d.allClasses = a;
    ...
    function l(a, b) {
      ...
      if (!0 === a) return a;
      if ('string' == typeof a)
        return (a = E(a)), '*' == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b));
    ...
    function f(a) {
      var b,
        ...
        f = {},
        g = 1;
      for (a = E(a); (b = a.match(t)); )
        (c = b[2])
          ? ((d = y(c, 'styles')), (e = y(c, 'attrs')), (c = y(c, 'classes')))
          : (d = e = c = null),
          (f['$' + g++] = { elements: b[1], classes: c, styles: d, attributes: e }),
      ...
      if (f.doFilter) {
        ...
        if (!a.allAttributes)
          for (k in t)
            F[k] ||
              (Q.test(k)
                ? k == (A = k.replace(/^data-cke-saved-/, '')) || F[A] || (delete t[k], (w = !0))
                : (delete t[k], (w = !0)));
    ...
    function K(a, b, c) {
      var d = a.name;
      if (r.$empty[d] || !a.children.length)
        'hr' == d && 'br' == b
          ? a.replaceWith(q())
          : (a.parent && c.push({ check: 'it', el: a.parent }), a.remove());
      else if (r.$block[d] || 'tr' == d)
        if ('br' == b)
          a.previous && !I(a.previous) && ((b = q()), b.insertBefore(a)),
            a.next && !I(a.next) && ((b = q()), b.insertAfter(a)),
          ...
          if (e) (a.name = b), (a.attributes = {}), c.push({ check: 'parent-down', el: a });
            ...
            e = a.parent;
            for (
              var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || 'body' == e.name,
                u,
                t,
                g = d.length;
              0 < g;
              ...
              (m = d[--g]),
                f &&
                (m.type == CKEDITOR.NODE_TEXT ||
                  (m.type == CKEDITOR.NODE_ELEMENT && r.$inline[m.name]))
                  ? (u ||
                      ((u = new CKEDITOR.htmlParser.element(b)),
                      u.insertAfter(a),
                      c.push({ check: 'parent-down', el: u })),
                    u.add(m, 0))
                  : ((u = null),
                    (t = r[e.name] || r.span),
                    m.insertAfter(a),
      ...
      if (c && !b) {
        ...
        !0 === d
          ...
          : (d || (this.customConfig = !1),
            ...
            this.allow(w[c.enterMode] + ' ' + w[c.shiftEnterMode], 'default', 1),
    ...
    CKEDITOR.filter.prototype = {
      allow: function (b, c, d) {
        ...
        if ('string' == typeof b) b = f(b);
          ...
          d &&
            ((d = F(d)),
            (m.classes = d['class'] ? d['class'].split(/\s+/) : null),
            (m.requiredClasses = m.classes),
            delete d['class'],
            (m.attributes = d),
            (m.requiredAttributes = d && CKEDITOR.tools.object.keys(d)));
      ...
      applyTo: function (a, b, c, d) {
          ...
          function (a) {
            if (a.type == CKEDITOR.NODE_ELEMENT) {
              ...
              if (
                !b ||
                'span' != a.name ||
                !~CKEDITOR.tools.object.keys(a.attributes).join('|').indexOf('data-cke-')
              )
        ...
        for (; (E = a.pop()); )
          if (((c = E.el), c.parent))
            switch (((h = r[c.parent.name] || r.span), E.check)) {
              case 'it':
                r.$removeEmpty[c.name] && !c.children.length ? K(c, d, a) : n(c) || K(c, d, a);
                break;
              case 'el-up':
                c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || h[c.name] || K(c, d, a);
                break;
              case 'parent-down':
        ...
        if (!this.disabled && a) {
          ...
          for (e = 0; e < a.length; ++e) {
            ...
            for (m = 0; m < b.length; ++m)
              (g = b[m]),
                'string' == typeof g
                  ? ((g = g.split(/\s*:\s*/)), (u = g[0]), (t = null), (r = g[1]))
                  : ((u = g.check), (t = g.left), (r = g.right)),
                f ||
                  ((f = g),
                  (f = f.element
                    ? f.element
      ...
      check: function (a, b, c) {
        ...
        if ('string' == typeof a) {
          ...
          (e = a.getDefinition()),
            (u = e.styles),
            (d = e.attributes || {}),
            u && !CKEDITOR.tools.isEmpty(u)
              ? ((u = F(u)), (d.style = CKEDITOR.tools.writeCssText(u, !0)))
              : (u = {}),
            (e = {
              name: e.element,
              attributes: d,
        ...
        if (!1 !== b && (r = this._.transformations[e.name])) {
          for (d = 0; d < r.length; ++d) m(this, e, r[d]);
          v(e);
        }
        x(this, u, t, {
          doFilter: !0,
        ...
        0 < t.length
          ...
          : ((b = e.attributes['class']) &&
              (e.attributes['class'] = e.attributes['class'].split(' ').sort().join(' ')),
            (c = CKEDITOR.tools.objectCompare(e.attributes, u.attributes, !0)),
    ...
    B = CKEDITOR.filter.transformationsTools = {
      ...
      transform: function (a, b) {
        if ('string' == typeof b) a.name = b;
          ...
          for (f in e)
            if ('class' == f)
              for (c = a.classes.join('|'), g = e[f].split(/\s+/); (u = g.pop()); )
                -1 == c.indexOf(u) && a.classes.push(u);
  ...
  (function () {
    var a,
      d = function (b) {
        ...
        a ||
          (e && (a = !1 !== l.execCommand(e, { from: 'keystrokeHandler' })),
            ...
            C = function (b) {
              if (a[b]) z(b, !0);
                ...
                if (!(1 < e.length)) {
                  ...
                  c &&
                    (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat)
                      ? (f.$.onreadystatechange = function () {
                          if ('loaded' == f.$.readyState || 'complete' == f.$.readyState)
                            (f.$.onreadystatechange = null), x(b, !0);
                        })
                      : ((f.$.onload = function () {
                          setTimeout(function () {
                            f.$.onload = null;
  ...
  CKEDITOR.resourceManager.prototype = {
    add: function (a, d) {
      if (this.registered[a])
        throw Error(
          '[CKEDITOR.resourceManager.add] The resource name "' + a + '" is already registered.'
        );
    ...
    load: function (a, d, b) {
      ...
      for (
        var c = this.loaded, g = this.registered, e = [], l = {}, h = {}, k = 0;
        k < a.length;
        k++
      ) {
        var p = a[k];
          ...
          a.call(
            ...
            function (a) {
              ...
              for (f in a) {
                ...
                if (!d[f]) {
                  if (h.icons)
                    for (var x = h.icons.split(','), C = x.length; C--; )
                ...
                if (z)
                  for (z.split && (z = z.split(',')), h = 0; h < z.length; h++)
                    e[z[h]] || b.push(z[h]);
              }
              if (b.length) l.call(this, b);
                ...
                for (f in e)
                  (h = e[f]),
                    h.onLoad &&
                      !h.onLoad._called &&
                      (!1 === h.onLoad() && delete e[f], (h.onLoad._called = 1));
                c && c.call(g || window, e);
              }
            },
            this
  ...
  (function () {
    function a(a, f, g) {
      ...
      if (void 0 !== f) {
        ...
        if (!b(f, g))
          throw Error(
            'The specified element mode is not supported on element: "' + f.getName() + '".'
          );
        this.element = f;
        this.elementMode = g;
        this.name =
          this.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO && (f.getId() || f.getNameAtt());
    ...
    function l(a) {
      ...
      c.fn
        ? (c.fn.call(a, a.config),
          (CKEDITOR.getUrl(a.config.customConfig) != b && l(a)) || a.fireOnce('customConfigLoaded'))
        ...
        a.readOnly = c.readOnly
          ...
          : a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE
            ? a.element.is('textarea')
              ? a.element.hasAttribute('disabled') || a.element.hasAttribute('readonly')
    ...
    function y(a) {
      ...
      var c = a.config,
        ...
        f = b(c.removePlugins);
      if (e)
        var g = new RegExp('(?:^|,)(?:' + e.replace(/,/g, '|') + ')(?\x3d,|$)', 'g'),
          d = d.replace(g, ''),
          d = d + (',' + e);
      if (f)
        var h = new RegExp('(?:^|,)(?:' + f.replace(/,/g, '|') + ')(?\x3d,|$)', 'g'),
          d = d.replace(h, '');
                ...
                (k =
                  k != a.langCode && 0 <= CKEDITOR.tools.indexOf(l, k)
                    ...
                    : 0 <= CKEDITOR.tools.indexOf(l, 'en')
                      ? 'en'
                      : l[0])),
            g.langEntries && g.langEntries[k]
              ? ((a.lang[m] = g.langEntries[k]), (k = null))
              : f.push(CKEDITOR.getUrl(g.path + 'lang/' + k + '.js')));
          e.push(k);
          d.push(g);
        }
            ...
            for (var b = ['beforeInit', 'init', 'afterInit'], f = 0; f < b.length; f++)
              for (var g = 0; g < d.length; g++) {
                ...
                0 === f &&
                  ...
                  m.lang &&
                  m.langEntries &&
                  (a.lang[m.name] = m.langEntries[e[g]]);
                if (m[b[f]]) m[b[f]](a);
              }
    ...
    function x(a, b) {
      function c(a) {
        var b = a.startContainer,
          d = a.endContainer;
        return b.is &&
          (b.is('tr') || (b.is('td') && b.equals(d) && a.endOffset === b.getChildCount()))
          ? !0
          : !1;
      }
      function d(a) {
      ...
      for (var e = new CKEDITOR.dom.documentFragment(), f, g, h, l = 0; l < a.length; l++) {
        ...
        c(k)
          ? (f ||
              ((f = r.getAscendant('table').clone()),
              f.append(r.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()),
              e.append(f),
              (f = f.findOne('thead, tbody, tfoot'))),
            (g && g.equals(r)) || ((g = r), (h = r.clone()), f.append(h)),
            h.append(d(k)))
      ...
      plugins: {
        detectConflict: function (a, b) {
          for (var c = 0; c < b.length; c++) {
            var d = b[c];
            if (this[d])
              return CKEDITOR.warn('editor-plugin-conflict', { plugin: a, replacedWith: d }), !0;
          }
          return !1;
        },
      },
    ...
    CKEDITOR.editor._getEditorElement = function (a) {
      ...
      return b
        ? b.getEditor()
          ? (CKEDITOR.error('editor-element-conflict', { editorName: b.getEditor().name }), null)
          : b
      ...
      parse: function (b) {
        for (var c, g, e = 0, l; (c = this._.htmlPartsRegex.exec(b)); ) {
          ...
          if ((g = c[1]))
            if (
              ((g = g.toLowerCase()),
              l && CKEDITOR.dtd.$cdata[g] && (this.onCDATA(l.join('')), (l = null)),
              !l)
            ) {
              this.onTagClose(g);
              continue;
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (e, l, h) {
      function k(a) {
        var b;
        if (0 < n.length)
      ...
      function y(b, c, d) {
        ...
        var e = q;
        void 0 === b.previous &&
          (z(c, b) && ((q = c), C.onTagOpen(h, {}), (b.returnPoint = c = q)),
          f(b),
      ...
      function z(a, b) {
        if ((a == v || 'body' == a.name) && h && (!a.name || CKEDITOR.dtd[a.name][h])) {
          var c, d;
          return (
            ((c = b.attributes && (d = b.attributes['data-cke-real-element-type']) ? d : b.name) &&
        ...
        if (a(f)) n.push(f);
          ...
          if ('br' == e) H.push(f);
            ...
            for (
              ;
              !((h = (g = q.name)
                ? CKEDITOR.dtd[g] || (q._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                : c),
              f.isUnknown || q.isUnknown || h[e]);
              ...
              if (q.isOptionalClose) C.onTagClose(g);
                ...
                (g = q.children),
                  ((g = g[g.length - 1]) && 'li' == g.name) ||
                    y((g = new CKEDITOR.htmlParser.element('li')), q),
                  !f.returnPoint && (f.returnPoint = q),
                  (q = g);
              else if (e in CKEDITOR.dtd.$listItem && !x(e, g))
                C.onTagOpen('li' == e ? 'ul' : 'dl', {}, 0, 1);
      ...
      C.onTagClose = function (a) {
        ...
        for (var c = [], d = [], e = q; e != v && e.name != a; )
          e._.isBlockLike || d.unshift(e), c.push(e), (e = e.returnPoint || e.parent);
        if (e != v) {
      ...
      C.onText = function (a) {
        if (
          !((q._.hasInlineStarted && !H.length) || K || I) &&
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        onElement: function (a, c) {
          for (
            var d = [this.elementsRules['^'], this.elementsRules[c.name], this.elementsRules.$],
              e,
              l = 0;
            3 > l;
            l++
    ...
    a.prototype = {
      ...
      addMany: function (a, c, d) {
        for (var e = [this.findIndex(c), 0], l = 0, h = a.length; l < h; l++)
          e.push({ value: a[l], priority: c, options: d });
      ...
      execOnName: function (a, c) {
        for (var d = 0, e = this.rules, l = e.length, h; c && d < l; d++)
          (h = e[d]),
  ...
  (function () {
        ...
        return function (g) {
          if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var u = [],
              ...
              h;
            if (m)
              for (r(m, 1) && u.push(m); m; )
                e(m) &&
                  (t = c(m)) &&
                  r(t) &&
                  ((h = c(t)) && !e(h) ? u.push(t) : (f(E).insertAfter(t), t.remove())),
                  (m = m.previous);
            for (m = 0; m < u.length; m++) u[m].remove();
            if ((u = !a || !1 !== ('function' == typeof d ? d(g) : d)))
              E || CKEDITOR.env.needsBrFiller || g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                ? E ||
                  CKEDITOR.env.needsBrFiller ||
                  !(
                  ...
                  ? ((u = b(g)), (u = !u || ('form' == g.name && 'input' == u.name)))
                  : (u = !1)
                : (u = !1);
            u && g.add(f(a));
          }
      ...
      function r(a, b) {
        ...
        return a.type == CKEDITOR.NODE_TEXT &&
          ...
          (c.index &&
            ...
            (a.value = c[0])),
          (!CKEDITOR.env.needsBrFiller && E && (!b || a.parent.name in w)) ||
            (!E && (((c = a.previous) && 'br' == c.name) || !c || e(c))))
          ? !0
          : !1;
      }
      var h = { elements: {} },
    ...
    function e(a) {
      return (
        a &&
        ((a.type == CKEDITOR.NODE_ELEMENT && a.name in m) ||
    ...
    function f(a, b) {
      return a.replace(b, function (a, b, c) {
        0 === a.indexOf('\x3ctextarea') &&
          (a = b + x(c).replace(/</g, '\x26lt;').replace(/>/g, '\x26gt;') + '\x3c/textarea\x3e');
    ...
    CKEDITOR.htmlDataProcessor = function (b) {
      ...
      b.on(
        'toHtml',
        function (a) {
          a.data.filter.applyTo(a.data.dataValue, !0, a.data.dontFilter, a.data.enterMode) &&
            b.fire('dataFiltered');
        },
        null,
        null,
          ...
          iframe: function (a) {
            if (a.attributes && a.attributes.src) {
              ...
              if (0 === b.indexOf('javascript') || 0 === b.indexOf('data'))
                (a.attributes['data-cke-pa-src'] = a.attributes.src), delete a.attributes.src;
            }
          },
        },
      },
        ...
        elements: {
          ...
          table: function (a) {
            a.children.slice(0).sort(function (a, b) {
              ...
              a.type == CKEDITOR.NODE_ELEMENT &&
                b.type == a.type &&
                ((c = CKEDITOR.tools.indexOf(K, a.name)), (d = CKEDITOR.tools.indexOf(K, b.name)));
              (-1 < c && -1 < d && c != d) ||
                ((c = a.parent ? a.getIndex() : -1), (d = b.parent ? b.getIndex() : -1));
              return c > d ? 1 : -1;
            });
          },
          param: function (a) {
    ...
    n = (function () {
      ...
      var c = new RegExp(
          '(' +
            a('\x3ccke:encoded\x3e') +
            '(.*?)' +
            a('\x3c/cke:encoded\x3e') +
            ')|(' +
            a('\x3c') +
            a('/') +
            '?' +
  ...
  (function () {
    function a(a) {
      return function (b) {
        return (
          b.type == CKEDITOR.NODE_ELEMENT && ('string' == typeof a ? b.name == a : b.name in a)
        );
      };
    }
    var d = function (a, b) {
    ...
    CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(
      new CKEDITOR.htmlParser.node(),
      {
        ...
        split: function (a) {
          for (
            var b = this.children.splice(a, this.children.length - a), d = this.clone(), l = 0;
            l < b.length;
            ++l
          )
            b[l].parent = d;
        ...
        removeClass: function (a) {
          var b = this.attributes['class'];
          b &&
            ((b = CKEDITOR.tools.trim(b.replace(new RegExp('(?:\\s+|^)' + a + '(?:\\s+|$)'), ' ')))
  ...
  (function () {
    ...
    CKEDITOR.template.prototype.output = function (d, b) {
      var c = ('function' === typeof this.source ? this.source(d) : this.source).replace(
        a,
        function (a, b) {
  ...
  (function () {
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (b in CKEDITOR.dtd.$editable)
        for (var c = CKEDITOR.document.getElementsByTag(b), g = 0, e = c.count(); g < e; g++)
          (a = c.getItem(g)),
    ...
    CKEDITOR.replaceAll = function () {
      for (var a = document.getElementsByTagName('textarea'), b = 0; b < a.length; b++) {
        ...
        if (l.name || l.id) {
          ...
          } else if ('function' == typeof arguments[0] && ((d = {}), !1 === arguments[0](l, d)))
            continue;
          this.replace(l, d);
        }
      }
  ...
  (function () {
    function a(a) {
      ...
      if (CKEDITOR.env.gecko || (CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller))
        if ((g = d(g, e)))
          g.appendBogus(),
            (h =
              (CKEDITOR.env.ie && !CKEDITOR.env.edge) || (CKEDITOR.env.edge && b._.previousActive));
      l(b, e.block, f) &&
        r.collapsed &&
        !r.getCommonAncestor().isReadOnly() &&
        ((e = r.clone()),
        ...
        ((b = r.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? 'div' : 'p')),
        CKEDITOR.env.needsBrFiller ||
          ((b = b.getFirst(c)) &&
            b.type == CKEDITOR.NODE_TEXT &&
    ...
    function l(a, b, c) {
      return (
        ...
        ((a.editable().equals(c) && !b) || (b && 'true' == b.getAttribute('contenteditable')))
      );
    }
    function h(a) {
      ...
      proto: {
        focus: function () {
          ...
          if (
            CKEDITOR.env.webkit &&
            !this.hasFocus &&
            ((a = this.editor._.previousActive || this.getDocument().getActive()), this.contains(a))
          ) {
            a.focus();
            return;
          }
        ...
        restoreAttrs: function () {
          ...
          for (c in a)
            a.hasOwnProperty(c) &&
              ((b = a[c]), null !== b ? this.setAttribute(c, b) : this.removeAttribute(c));
        },
        ...
        insertElementIntoRange: function (a, b) {
          ...
          b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
            (b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 })
              ? H(b)
              : b.startContainer.is(CKEDITOR.dtd.$list) && q(b));
          var g, h;
          if (f)
            for (
              ;
        ...
        extractHtmlFromRange: function (a, b) {
          ...
          if (b) {
            ...
            if (
              (d =
                a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block))
            ) {
              a: {
            ...
            c.autoParagraph(this.editor, a), x(a.startContainer) && a.startContainer.appendBogus();
              ...
              if (0 !== b.getRanges().length) {
                if (c in k) {
                  var f,
                    ...
                    B,
                    c = 8 == c;
                  (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (f = b.getSelectedElement())) ||
                  (f = e(b))
                    ? (a.fire('saveSnapshot'),
                    ...
                    : g.collapsed &&
                      ((r = h.block) &&
                      (B = r[c ? 'getPrevious' : 'getNext'](y)) &&
                      B.type == CKEDITOR.NODE_ELEMENT &&
                      B.is('table') &&
                      g[c ? 'checkStartOfBlock' : 'checkEndOfBlock']()
                        ? (a.fire('saveSnapshot'),
                          g[c ? 'checkEndOfBlock' : 'checkStartOfBlock']() && r.remove(),
                          g['moveToElementEdit' + (c ? 'End' : 'Start')](B),
                          g.select(),
                          a.fire('saveSnapshot'),
                          (d = 1))
                        : h.blockLimit &&
                            h.blockLimit.is('td') &&
                            (l = h.blockLimit.getAscendant('table')) &&
                            g.checkBoundaryOfElement(l, c ? CKEDITOR.START : CKEDITOR.END) &&
                            (B = l[c ? 'getPrevious' : 'getNext'](y))
                          ? (a.fire('saveSnapshot'),
                            g['moveToElementEdit' + (c ? 'End' : 'Start')](B),
                            g.checkStartOfBlock() && g.checkEndOfBlock() ? B.remove() : g.select(),
                            a.fire('saveSnapshot'),
                            (d = 1))
                          : (l = h.contains(['td', 'th', 'caption'])) &&
                            g.checkBoundaryOfElement(l, c ? CKEDITOR.START : CKEDITOR.END) &&
                            (d = 1));
                }
                return !d;
            ...
            CKEDITOR.env.gecko &&
              this.attachListener(this, 'mouseup', function (b) {
                if (
                  2 == b.data.$.button &&
                  ((b = b.data.getTarget()),
                  !b.getAscendant('table') && !b.getOuterHtml().replace(v, ''))
                ) {
                  var c = a.createRange();
                  ...
                  if (c in k && ((b = a.getSelection()), 0 !== b.getRanges().length)) {
                    ...
                    if (d.collapsed)
                      ...
                      (c = d),
                        ...
                        h && d && !h.equals(d)
                          ? (a.fire('saveSnapshot'),
                            (e = h.getBogus()) && e.remove(),
                            c.enlarge(CKEDITOR.ENLARGE_INLINE),
                            c.deleteContents(),
                            d.getParent() &&
                              (d.moveChildren(h, !1), b.lastElement.mergeSiblings(), f(h, d, !0)),
          ...
          if (!this.is('textarea')) {
            ...
            if (b.getCustomData('stylesheet')) {
              ...
              --c
                ...
                : (a.removeCustomData('stylesheet_ref'), b.removeCustomData('stylesheet').remove());
            }
          }
        },
      },
    ...
    CKEDITOR.editor.prototype.editable = function (a) {
      ...
      a
        ? (b = a instanceof CKEDITOR.editable ? a : new CKEDITOR.editable(this, a))
        : (b && b.detach(), (b = null));
          ...
          if (
            ...
            var e = CKEDITOR.tools.getNextId(),
              d = CKEDITOR.dom.element.createFromHtml(
                '\x3cspan id\x3d"' + e + '" class\x3d"cke_voice_label"\x3e' + d + '\x3c/span\x3e'
              );
            c.append(d);
    ...
    n = (function () {
      ...
      function b(c, d) {
        ...
        for (
          ...
          (e = F.getItem(k)),
            a(e)
              ? ((g = e.getName()),
                A && g in CKEDITOR.dtd.$list
                  ? (r = r.concat(b(e, d)))
                  : ((h = !!l[g]),
                    'br' != g ||
                      !e.data('cke-eol') ||
                      (k && k != w - 1) ||
                      ((Q = (f = k ? r[k - 1].node : F.getItem(k + 1)) && (!a(f) || !f.is('br'))),
                      (f = f && a(f) && E.$block[f.getName()])),
                    -1 != p || h || (p = k),
                    h || (n = k),
                    r.push({
                      isElement: 1,
                    ...
                    (f = Q = 0)))
              : r.push({ isElement: 0, node: e, allowed: 1 });
      ...
      function d(b, c) {
        ...
        for (k && e.push(' '); r < g; r++)
          (h = f.getItem(r)), a(h) && !h.is(l) ? (e = e.concat(d(h, c))) : e.push(h);
        k && e.push(' ');
        return e;
      }
      function e(b) {
      ...
      function g(b, c, d, e) {
        ...
        (h = new CKEDITOR.dom.walker(f).next()) &&
          ...
          (l = h.getPrevious()) &&
          a(l) &&
          !l.getParent().equals(b.startContainer) &&
          d.contains(l) &&
          e.contains(h) &&
          h.isIdentical(l) &&
          (h.moveChildren(l), h.remove(), g(b, c, d, e));
      }
      function F(b, c) {
        function d(b, c) {
      ...
      return function (t, w, J, u) {
        ...
        if (!u.checkReadOnly()) {
          ...
          for (; (Z = e(D)) && a(Z) && Z.isBlockBoundary() && T.contains(Z); )
            D.moveToPosition(Z, CKEDITOR.POSITION_BEFORE_END);
          g(D, w.blockLimit, T, H);
          C && (D.setEndBefore(C), D.collapse(), C.remove());
          C = D.startPath();
          if ((q = C.contains(f, !1, 1)))
            (y = D.splitElement(q)), (w.inlineStylesRoot = q), (w.inlineStylesPeak = C.lastElement);
          C = D.createBookmark();
          x && (k(q), k(y));
          ...
          if ((t = J)) {
            ...
            if ('text' == w.type && w.inlineStylesRoot) {
              ...
              for (y = w.inlineStylesRoot.getParent(); !u.equals(y); )
                (B = B.appendTo(u.clone())), (u = u.getParent());
            ...
            if ((V = t.startPath().block) && (1 != V.getChildCount() || !V.getBogus()))
              a: {
                var P;
                if (
                  1 == u.getChildCount() &&
          ...
          if (t) {
            ...
            var ba,
              D = Z.getPosition(B),
              z =
                !!Z.getCommonAncestor(B) &&
                D != CKEDITOR.POSITION_IDENTICAL &&
                !(D & (CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED)),
              B = b(w.dataWrapper, w);
            for (F(B, P); y < B.length; y++) {
              ...
              if ((x = D.isLineBreak))
                (x = P),
                  ...
                  D.hasBlockSibling
                    ? (x = 1)
                    : (T = x.startContainer.getAscendant(E.$block, 1)) && T.is({ div: 1, p: 1 })
                      ? ((H = T.getPosition(q)),
                        H == CKEDITOR.POSITION_IDENTICAL || H == CKEDITOR.POSITION_CONTAINS
                          ? (x = 0)
                          : ((q = x.splitElement(T)),
                            x.moveToPosition(q, CKEDITOR.POSITION_AFTER_START),
                            (x = 1)))
                      : (x = 0);
              if (x) J = 0 < y;
              else {
                ...
                if (C && D.isElement) {
                  ...
                  if (x) q && ((K = P.splitElement(q)), w.zombies.push(K), w.zombies.push(q));
                    ...
                    T = [];
                    H = q.length;
                    for (var ca = 0, ea = void 0, X = 0, W = -1; ca < H; ca++)
                      (ea = q[ca]),
                        ' ' == ea
                          ? (X ||
                              (ba && !ca) ||
                              (T.push(new CKEDITOR.dom.text(' ')), (W = T.length)),
                            (X = 1))
                          : (T.push(ea), (X = 0));
                    x && W == T.length && T.pop();
                    ba = T;
                ...
                D.lastNotAllowed &&
                  y < B.length - 1 &&
                  ((K = z ? Z : K) && P.setEndAt(K, CKEDITOR.POSITION_AFTER_START), (C = 0));
                P.collapse();
              }
            }
            1 != B.length
              ? (R = !1)
              : ((R = B[0]),
                (R = R.isElement && 'false' == R.node.getAttribute('contenteditable')));
            R &&
              ((J = !0),
              (x = B[0].node),
              P.setStartAt(x, CKEDITOR.POSITION_BEFORE_START),
              P.setEndAt(x, CKEDITOR.POSITION_AFTER_END));
            w.dontMoveCaret = J;
          ...
          for (I = R.createBookmark(); (N = w.zombies.pop()); )
            N.getParent() &&
              ((K = R.clone()), K.moveToElementEditStart(N), K.removeEmptyBlocksAtEnd());
          if (ba)
            for (; (N = ba.pop()); )
              CKEDITOR.env.needsBrFiller ? N.appendBogus() : N.append(R.document.createText(' '));
          for (; (N = w.mergeCandidates.pop()); ) N.mergeSiblings();
          CKEDITOR.env.webkit &&
            R.startPath() &&
            ((N = R.startPath()),
            N.block ? N.block.$.normalize() : N.blockLimit && N.blockLimit.$.normalize());
          R.moveToBookmark(I);
          if (!w.dontMoveCaret) {
      ...
      return function (b) {
        ...
        e.is(CKEDITOR.dtd.$list)
          ...
          : ((c = e.getBogus()) && c.remove(),
            b.moveToPosition(e, d ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END),
            b.select());
      };
    })();
    I = {
        ...
        table: (function () {
          function a(c) {
            ...
            g.guard = function (a, g) {
              ...
              if (g && h && a.equals(h))
                (f = c.clone()), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f);
              else if (!g && t && a.equals(t))
                (f = c.clone()), f.setStartAt(t, CKEDITOR.POSITION_AFTER_START), e.push(f);
              else {
                if ((k = !g))
                  k =
                    a.type == CKEDITOR.NODE_ELEMENT &&
                ...
                if (!k && (k = g))
                  if (a.is(d))
                    var k = h && h.getAscendant('table', !0),
          ...
          return {
            ...
            detectRanges: function (e, f) {
              var g = c(f, e.bookmark),
                ...
                l,
                t,
                k = g.getCommonAncestor();
              k.is(CKEDITOR.dtd.$tableContent) && !k.is(d) && (k = k.getAscendant('table', !0));
              t = k;
              k = new CKEDITOR.dom.elementPath(g.startContainer, t);
              ...
              if (k || t)
                k && t && b(k, t)
                  ? ((e.tableSurroundingRange = h),
                    h.setStartAt(k, CKEDITOR.POSITION_AFTER_END),
                    h.setEndAt(t, CKEDITOR.POSITION_BEFORE_START),
                    (h = g.clone()),
                    h.setEndAt(k, CKEDITOR.POSITION_AFTER_END),
                    (l = g.clone()),
                    l.setStartAt(t, CKEDITOR.POSITION_BEFORE_START),
                    (l = a(h).concat(a(l))))
                  : k
                    ? t ||
                      ((e.tableSurroundingRange = h),
                      h.setStartAt(k, CKEDITOR.POSITION_AFTER_END),
                      g.setEndAt(k, CKEDITOR.POSITION_AFTER_END))
                    : ((e.tableSurroundingRange = h),
                      h.setEndAt(t, CKEDITOR.POSITION_BEFORE_START),
                      g.setStartAt(t, CKEDITOR.POSITION_AFTER_START)),
                  (e.tableContentsRanges = l ? l : a(g));
            },
            deleteRanges: function (a) {
              for (var b; (b = a.tableContentsRanges.pop()); )
                b.extractContents(), x(b.startContainer) && b.startContainer.appendBogus();
  ...
  (function () {
    ...
    function d(b, c) {
      ...
      if ((d = !c && 1 === b.length) && !(d = b[0].collapsed)) {
        ...
        d && d.equals(g) && !d.findOne('td, th, tr, tbody, table')
          ? ((f = f.cloneContents()),
            (d = f.getFirst() ? e(f.getFirst().getText()) !== e(d.getText()) : !0))
          : (d = !1);
      }
      if (d) return !1;
    ...
    function e() {
      ...
      if (!b && ((b = c || this.getSelection(1)), !b || b.getType() == CKEDITOR.SELECTION_NONE))
        return;
      ...
      return function (c) {
        ...
        if (b[d]) {
          var e = a.getSelection(),
            f = e.getRanges()[0];
          e.isCollapsed() &&
            (f = f[38 > d ? 'getPreviousEditableNode' : 'getNextEditableNode']()) &&
            f.type == CKEDITOR.NODE_ELEMENT &&
            'false' == f.getAttribute('contenteditable') &&
            ((e = e.getStartElement()),
            !e.isBlockBoundary() ||
              '' !== (void 0 === e.$.textContent ? e.$.innerText : e.$.textContent) ||
              (8 !== d && 46 !== d) ||
              (e.remove(), a.fire('saveSnapshot')),
            a.getSelection().fake(f),
        ...
        if (!c.collapsed) {
          if (c.startContainer.isReadOnly())
            for (
              ...
              d && !(((e = d.type == CKEDITOR.NODE_ELEMENT) && d.is('body')) || !d.isReadOnly());
    ...
    CKEDITOR.on('instanceCreated', function (a) {
      ...
      c.on('contentDom', function () {
        ...
        function b() {
          ...
          'None' != a.type &&
            c.parentElement() &&
            c.parentElement().ownerDocument == g.$ &&
            c.select();
        }
        function d(a) {
          var b, c;
          ...
          b ||
            ...
            (c = f(b)) && !c.equals(k) && (b.selectElement(c), a.data.preventDefault()));
        }
        function f(a) {
          a = a.getRanges()[0];
          return a
          ...
          k.attachListener(
            ...
            function (a) {
              ...
              0 !== F &&
                ...
                a.isCollapsed &&
                a.anchorNode == k.$ &&
                ((a = c.createRange()), a.moveToElementEditStart(k), a.select());
            },
            null,
            null,
            -2
        ...
        k.attachListener(
          ...
          function () {
            if (F && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.gecko || p)
          n
            ? k.attachListener(k, 'beforedeactivate', a, null, null, -1)
            : k.attachListener(c, 'selectionCheck', a, null, null, -1),
            k.attachListener(
              k,
        ...
        if (CKEDITOR.env.ie && !p) {
          ...
          k.attachListener(k, 'mousedown', function (a) {
            2 == a.data.$.button &&
              (((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE) ||
                (q = c.window.getScrollPosition()));
          });
          k.attachListener(k, 'mouseup', function (a) {
            2 == a.data.$.button &&
              q &&
              ((c.document.$.documentElement.scrollLeft = q.x),
              (c.document.$.documentElement.scrollTop = q.y));
            q = null;
          });
              ...
              m.on('mousedown', function (a) {
                function b(a) {
                  ...
                  if (z) {
                    ...
                    z.setEndPoint(
                      0 > v.compareEndPoints('StartToStart', c) ? 'EndToEnd' : 'StartToStart',
                      c
                    );
                    z.select();
                  }
      ...
      c.on('key', function (a) {
        if ('wysiwyg' == c.mode) {
          ...
          if (b.isFake) {
            ...
            if (d)
              return d({ editor: c, selected: b.getSelectedElement(), selection: b, keyEvent: a });
          }
        }
      });
    });
          ...
          function () {
            ...
            c &&
              (c.getCustomData('ready')
                ? (y(a), a.editor.fire('selectionCheck'))
        ...
        : function () {
            ...
            if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
              ...
              d == c.endContainer &&
                ...
                M[d.childNodes[c.startOffset].nodeName.toLowerCase()] &&
              ...
              var b = function (b, c) {
                ...
                if (-1 == r || (r == e.length - 1 && 0 > m)) {
                  ...
                  for (d = e.length; 0 < h && 0 < d; )
                    (g = e[--d]),
                      g.nodeType == CKEDITOR.NODE_TEXT && ((p = g), (h -= g.nodeValue.length));
                ...
                for (; 0 < h; )
                  try {
                    (g = f[0 < m ? 'previousSibling' : 'nextSibling']),
                      g.nodeType == CKEDITOR.NODE_TEXT && ((h -= g.nodeValue.length), (p = g)),
                      (f = g);
                  } catch (n) {
      ...
      getStartElement: function () {
        ...
        switch (this.getType()) {
          ...
          case CKEDITOR.SELECTION_TEXT:
            ...
            if (c) {
              if (c.collapsed)
                (b = c.startContainer), b.type != CKEDITOR.NODE_ELEMENT && (b = b.getParent());
              else {
                for (
                  c.optimize();
                  (b = c.startContainer),
                    c.startOffset == (b.getChildCount ? b.getChildCount() : b.getLength()) &&
                      !b.isBlockBoundary();
          ...
          if (this.isLocked) {
            ...
            a: {
              ...
              if (
                ...
                ((J = J.clone()),
                J.shrink(CKEDITOR.SHRINK_ELEMENT, !0),
                (m = J.getEnclosedNode()) && m.type == CKEDITOR.NODE_ELEMENT && (k = m),
            ...
            if (k) this.fake(k);
              ...
              d(a) &&
              !K &&
              !a[0]._getTableElement({ table: 1 }).hasAttribute('data-cke-tableselection-ignored')
            )
              g.call(this, a);
            else {
              if (n) {
                ...
                if (
                  (b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                    b.startContainer.getName() in J) ||
                  (b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in J)
                )
                ...
                l
                  ...
                  : ((u = J.getNext(m)),
                    (B = J.hasAscendant('pre')),
                    (u =
                      !(u && u.getText && u.getText().match(k)) &&
                      (B || !J.hasPrevious() || (J.getPrevious().is && J.getPrevious().is('br')))),
                    (B = b.document.createElement('span')),
                    B.setHtml('\x26#65279;'),
                    B.insertBefore(J),
                    u && b.document.createText('﻿').insertBefore(J));
                b.setStartBefore(J);
                J.remove();
                a
                  ? (u
                      ? (D.moveStart('character', -1), D.select(), b.document.$.selection.clear())
                      : D.select(),
                    b.moveToPosition(B, CKEDITOR.POSITION_BEFORE_START),
                    B.remove())
                ...
                for (D = 0; D < a.length; D++) {
                  if (
                    ...
                    (B = a[D + 1]),
                    (k = u.clone()),
                    k.setStart(u.endContainer, u.endOffset),
                    k.setEnd(B.startContainer, B.startOffset),
                    !k.collapsed &&
                      (k.shrink(CKEDITOR.NODE_ELEMENT, !0),
                      (b = k.getCommonAncestor()),
                      (k = k.getEnclosedNode()),
                      b.isReadOnly() || (k && k.isReadOnly())))
                  ) {
                  ...
                  b.collapsed &&
                    ...
                    'br' == u.getName()
                      ? (y(this.root), b.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START))
                  ...
                  try {
                    ...
                    if (0 <= q.toString().indexOf('NS_ERROR_ILLEGAL_VALUE'))
                      b.collapse(1), B.setEnd(b.endContainer.$, b.endOffset);
                    else throw q;
                  }
                  l.addRange(B);
                }
  ...
  (function () {
    ...
    function b(c) {
      var e = c.document;
      if (c.collapsed)
        (e = H(this, e)), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
      else {
        var f = this.element,
          h = this._.definition,
          l,
        ...
        for (q.getPosition(y) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q; ) {
          ...
          if (q.equals(y)) (q = null), (k = !0);
            ...
            var v = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
              ...
              w = v && -1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, v),
            ...
            if (z && m && CKEDITOR.dtd.$block[v])
              for (
                var A = q,
                  ...
                  I = F.length,
                  K = 0,
                  A = I && new CKEDITOR.dom.range(A.getDocument());
                K < I;
                ++K
              ) {
                var G = F[K],
            ...
            if (F)
              if (
                ...
                (K = l),
                !G ||
                  (!(G.getDtd() || CKEDITOR.dtd.span)[I] && !K) ||
                  (F.parentRule && !F.parentRule(G)))
              )
                k = !0;
              else {
                if (
                  (r ||
                    (v && CKEDITOR.dtd.$removeEmpty[v] && (q.getPosition(y) | Q) != Q) ||
                    ((r = c.clone()), r.setStartBefore(q)),
                  (v = q.type),
                  v == CKEDITOR.NODE_TEXT ||
                    z ||
                    (v == CKEDITOR.NODE_ELEMENT && !q.getChildCount()))
                ) {
                  for (
                    var v = q, M;
                    (k = !v.getNext(E)) && ((M = v.getParent()), p[M.getName()]) && d(M, x, h, S);
            ...
            for (
              ...
              if (w.getName() == f) {
                for (X in h.attributes)
                  !I[X] &&
                    (Y = w.getAttribute(W)) &&
                    (k.getAttribute(X) == Y ? (F[X] = 1) : (I[X] = 1));
                for (W in h.styles)
                  !G[W] && (Y = w.getStyle(W)) && (k.getStyle(W) == Y ? (v[W] = 1) : (G[W] = 1));
              }
              w = w.getParent();
            }
    ...
    function c(a) {
      ...
      if (a.collapsed) {
        for (
          var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k;
          h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit;
          h++
        )
          if (this.checkElementRemovable(k)) {
            ...
            (a.checkBoundaryOfElement(k, CKEDITOR.END) ||
              ...
              : (k.mergeSiblings(),
                k.is(this.element) ? x.call(this, k) : v(k, K(this)[k.getName()]));
          }
        if (g) {
          e = d;
          for (h = 0; ; h++) {
        ...
        for (f = d; !f.equals(m); )
          (g = f.getNextSourceNode()),
            f.type == CKEDITOR.NODE_ELEMENT &&
              ...
              (f.getName() == this.element ? x.call(this, f) : v(f, K(this)[f.getName()]),
              g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), (g = d.getNext()))),
            (f = g);
      }
      a.moveToBookmark(c);
    ...
    function p(a, b) {
      ...
      if (d) {
        ...
        (k = c.getPrevious(w)) &&
          ...
          k.is('pre') &&
          ((d = y(k.getHtml(), /\n$/, '') + '\n\n' + y(c.getHtml(), /^\n/, '')),
          CKEDITOR.env.ie ? (c.$.outerHTML = '\x3cpre\x3e' + d + '\x3c/pre\x3e') : c.setHtml(d),
          k.remove());
      } else c && n(b);
    }
    function f(a) {
    ...
    function x(a, b) {
      var c = this._.definition,
        ...
        g;
      for (g in d)
        if (('class' != g && !this._.definition.fullMatch) || a.getAttribute(g) == m(g, d[g]))
          (b && 'data-' == g.slice(0, 5)) || ((f = a.hasAttribute(g)), a.removeAttribute(g));
      for (var h in c)
        (this._.definition.fullMatch && a.getStyle(h) != m(h, c[h], !0)) ||
    ...
    function C(a) {
      for (var b = K(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e; )
        (d = c.getItem(e)), d.isReadOnly() || x.call(this, d, !0);
      for (var f in b)
        if (f != this.element)
          for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)
            (d = c.getItem(e)), d.isReadOnly() || v(d, b[f]);
    }
    function v(a, b, c) {
      if ((b = b && b.attributes))
        for (var d = 0; d < b.length; d++) {
          ...
          if ((f = a.getAttribute(e))) {
            var g = b[d][1];
            (null === g || (g.test && g.test(f)) || ('string' == typeof g && f == g)) &&
              a.removeAttribute(e);
          }
        }
      c || n(a);
    ...
    function I(a, b) {
      for (var c in a)
        a[c] = a[c].replace(F, function (a, c) {
          return b[c];
        });
    }
    function K(a) {
      ...
      if (c) {
        ...
        for (var d = 0; d < c.length; d++) {
          ...
          'string' == typeof e
            ? (f = e.toLowerCase())
            : ((f = e.element ? e.element.toLowerCase() : a.element), (g = e.attributes));
          e = b[f] || (b[f] = {});
          if (g) {
    ...
    function G(a, b) {
      ...
      for (var d in a)
        if (!(d in b) || (c(b[d], d) != c(a[d], d) && 'inherit' != a[d] && 'inherit' != b[d]))
          return !1;
      return !0;
    }
    function L(a, b, c) {
    ...
    CKEDITOR.style = function (a, b) {
      ...
      this.type =
        a.type ||
        (A[c] ? CKEDITOR.STYLE_BLOCK : M[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
    ...
    attachStyleStateChange: function (a, d) {
      ...
      b ||
        ...
        this.on('selectionChange', function (a) {
          for (var d = 0; d < b.length; d++) {
            var e = b[d],
              l = e.style.checkActive(a.data.path, this)
  ...
  (function () {
    function a(a, c) {
      b(a)
        ? (a = Math.round(c * (parseFloat(a) / 100)))
        : 'string' === typeof a && a.match(/^\d+$/gm) && (a = parseInt(a, 10));
      return a;
    }
    function d(a, c) {
      b(a)
        ? (a = c * (parseFloat(a) / 100))
        : 'string' === typeof a && a.match(/^\d?\.\d+/gm) && (a = parseFloat(a));
      return a;
    }
    function b(a) {
    ...
    CKEDITOR.tools.color = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        getRgba: function () {
          return this._.isValidColor
            ? this._.formatRgbString('rgba', this._.red, this._.green, this._.blue, this._.alpha)
            : this._.defaultValue;
        },
        getHsl: function () {
          if (!this._.isValidColor) return this._.defaultValue;
      ...
      _: {
        ...
        extractColorChannelsFromRgba: function (b) {
          ...
          if (!c || ((b = 0 === b.indexOf('rgba')) && 4 !== c.length) || (!b && 3 !== c.length))
            return null;
        ...
        extractColorChannelsFromHsla: function (b) {
          ...
          if (!c || ((b = 0 === b.indexOf('hsla')) && 4 !== c.length) || (!b && 3 !== c.length))
            return null;
        ...
        areColorChannelsValid: function (a, b, d, g) {
          return (
            ...
            c(g, 0, CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE)
          );
        },
      ...
      do
        if (k.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (
            !this.lastElement &&
            ((this.lastElement = k),
            k.is(CKEDITOR.dtd.$object) || 'false' == k.getAttribute('contenteditable'))
          )
            continue;
          if (k.equals(g)) break;
          if (
            !l &&
            ((p = k.getName()),
            'true' == k.getAttribute('contenteditable') ? (l = k) : !e && d[p] && (e = k),
            a[p])
          ) {
            if ((p = !e && 'div' == p)) {
              a: {
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
    ...
    split: function (a) {
      ...
      d.childNodes.length == b &&
        (a >= c
          ? ((e = g.createText('')), e.insertAfter(this))
          : ((a = g.createText('')), a.insertAfter(e), a.remove()));
      return e;
    },
  ...
  (function () {
    function a(a, c, d) {
      ...
      l.equals(k.getPrevious())
        ? ((c.startOffset = c.startOffset - l.getLength() - a.getPrevious().getLength()),
          (l = a.getNext()))
        : l.equals(a.getPrevious()) && ((c.startOffset -= l.getLength()), (l = a.getNext()));
    ...
    var d = {
        ...
        return {
          getNextRange: function (l) {
            ...
            if (h && 1 < a.length) {
              ...
              if (l)
                for (var p = 0; a[e + p + 1]; ) {
                  ...
                  for (f = f.getById(d[p + 1].startNode); ; ) {
                    ...
                    if (f.equals(k)) l = 1;
                    else if (c(k) || (k.type == CKEDITOR.NODE_ELEMENT && k.isBlockBoundary()))
                      continue;
                    break;
                  }
                  if (!l) break;
              ...
              for (h.moveToBookmark(d.shift()); p--; )
                (k = a[++e]), k.moveToBookmark(d.shift()), h.setEnd(k.endContainer, k.endOffset);
            }
            return h;
          },
        };
      ...
      createBookmarks: function (b) {
        for (var c = [], d, e = 0; e < this.length; e++) {
          ...
          for (var l = e + 1; l < this.length; l++)
            (this[l] = a(d, this[l])), (this[l] = a(d, this[l], !0));
        }
        return c;
      },
      createBookmarks2: function (a) {
      ...
      setUiColor: function (a) {
        ...
        return (this.setUiColor = function (a) {
          ...
          var c = CKEDITOR.skin.chameleon,
            d = '',
            e = '';
          'function' == typeof c && ((d = c(this, 'editor')), (e = c(this, 'panel')));
          a = [[k, a]];
          g([b], d, a);
          g(h, e, a);
        }).call(this, a);
      ...
      if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
        ...
        a = function (a) {
          ...
          if (!a.getById('cke_ui_color')) {
            ...
            (a = b.getUiColor()) && g([d], CKEDITOR.skin.chameleon(b, 'panel'), [[k, a]]);
          }
        };
        b.on('panelShow', a);
        b.on('menuShow', a);
...
*/
        ...
        return function (b, d) {
          for (var a = b.match(/[^#]./g), e = 0; 3 > e; e++) {
            var f = e,
              c;
            c = parseInt(a[e], 16);
            c = ('0' + (0 > d ? 0 | (c * (1 + d)) : 0 | (c + (255 - c) * d)).toString(16)).slice(
              -2
            );
            a[f] = c;
          }
            ...
            if (!(4 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, 'div', null, e, function () {
                ...
                'horizontal' != a.labelLayout
                  ? e.push(
                      '\x3clabel class\x3d"cke_dialog_ui_labeled_label' + g + '" ',
                      ' id\x3d"' + c.labelId + '"',
                      c.inputId ? ' for\x3d"' + c.inputId + '"' : '',
                      (a.labelStyle ? ' style\x3d"' + a.labelStyle + '"' : '') + '\x3e',
                      a.label,
                      '\x3c/label\x3e',
                      '\x3cdiv class\x3d"cke_dialog_ui_labeled_content"',
                      a.controlStyle ? ' style\x3d"' + a.controlStyle + '"' : '',
          ...
          fileButton: function (b, a, d) {
            ...
            if (!(3 > arguments.length)) {
              ...
              c.onClick = function (c) {
                ...
                c = e ? e.call(this, c) : !1;
                !1 !== c &&
                  ('xhr' !== c && b.getContentElement(d[0], d[1]).submit(), this.disable());
              };
              b.on('load', function () {
      ...
      a.parts.title.on(
        ...
        function (g) {
          ...
          CKEDITOR.env.ie6Compat &&
            ((f = u.getChild(0).getFrameDocument()), f.on('mousemove', b), f.on('mouseup', c));
    ...
    CKEDITOR.dialog = function (a, b) {
      ...
      function d(b) {
        if (n == CKEDITOR.dialog._.currentTop) {
          ...
          else if (c == CKEDITOR.ALT + 121 && !n._.tabBarMode && 1 < n.getPageCount())
            I(n), (q = 1);
          else if (-1 != CKEDITOR.tools.indexOf(g, c) && n._.tabBarMode)
            (c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? J.call(n) : W.call(n)),
              n.selectPage(c),
              n._.tabs[c][0].focus(),
              (q = 1);
            ...
            if (13 == c)
              (c = b.data.getTarget()),
                c.is('a', 'button', 'select', 'textarea') ||
                  ...
                  ((c = this.getButton('ok')) && CKEDITOR.tools.setTimeout(c.click, 0, c), (q = 1)),
                (l = 1);
            else if (27 == c)
      ...
      k = CKEDITOR.dialog._.uiElementBuilders.hbox
        .build(
          this,
          { type: 'hbox', className: 'cke_dialog_footer_buttons', widths: [], children: g.buttons },
          m
        )
        .getChild();
    ...
    CKEDITOR.dialog.prototype = {
      ...
      show: function () {
        ...
        null === CKEDITOR.dialog._.currentTop
          ? ((CKEDITOR.dialog._.currentTop = this), (this._.parentDialog = null), P(this._.editor))
          : CKEDITOR.dialog._.currentTop !== this &&
            ((this._.parentDialog = CKEDITOR.dialog._.currentTop),
            (c = this._.parentDialog.getElement().getFirst()),
            (c.$.style.zIndex -= Math.floor(e / 2)),
            this._.parentDialog.getElement().setStyle('z-index', c.$.style.zIndex),
            (CKEDITOR.dialog._.currentTop = this));
        a.on('keydown', R);
        a.on('keyup', S);
        this._.hasFocus = !1;
            ...
            if (e) {
              for (var g in this._.contents[a.id]) {
                ...
                'hbox' != h.type &&
                  'vbox' != h.type &&
                  h.getInputElement() &&
                  (h.requiredContent && !this._.editor.activeFilter.check(h.requiredContent)
                    ? h.disable()
                    : (h.enable(), f++));
              }
      ...
      addPage: function (a) {
        if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
          for (
            var b = [],
              c = a.label ? ' title\x3d"' + CKEDITOR.tools.htmlEncode(a.label) + '"' : '',
      ...
      CKEDITOR.ui.dialog = {
        uiElement: function (a, b, c, e, d, f, g) {
          if (!(4 > arguments.length)) {
            ...
            for (
              var n = k['class'] && k['class'].split ? k['class'].split(' ') : [], l = 0;
              l < n.length;
              l++
            )
              n[l] && (r[n[l]] = 1);
            ...
            a.on('load', function () {
              ...
              if (b) {
                var c =
                  t.type in { checkbox: 1, ratio: 1 } && CKEDITOR.env.ie && 8 > CKEDITOR.env.version
              ...
              function () {
                ...
                b.push(
                  ...
                  CKEDITOR.tools.htmlEncode(
                    (d && d.align) || ('ltr' == a.getParentEditor().lang.dir ? 'left' : 'right')
                  ),
                  '" '
                );
                ...
                for (var e = 0; e < c.length; e++) {
                  ...
                  h
                    ? k.push('height:' + y(h[e]))
                    : d && d.expand && k.push('height:' + Math.floor(100 / c.length) + '%');
        ...
        if ('function' == typeof d)
          ...
          if ('failed' == d)
            throw (
              (Q(this),
              Error(
                '[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.'
              ))
            );
          'string' == typeof d &&
            CKEDITOR.scriptLoader.load(
  ...
  (function () {
    ...
    q.prototype = {
      ...
      update: function (b) {
        var a = !0;
        !1 === this.editor.fire('notificationUpdate', { notification: this, options: b }) &&
          (a = !1);
        var c = this.element,
        ...
        void 0 !== b.progress &&
          ((this.progress = b.progress), e && e.setStyle('width', this._getPercentageProgress()));
        a &&
          b.important &&
          (c.setAttribute('role', 'alert'), this.isVisible() || this.area.add(this));
  ...
  (function () {
    var c =
      ...
      (CKEDITOR.env.gecko && !CKEDITOR.env.hc ? '' : ' href\x3d"javascript:void(\'{titleJs}\')"') +
      ...
      render: function (a, b) {
        ...
        var e = {
          ...
          x = CKEDITOR.tools.addFunction(function (a) {
            if (e.onkey)
              return (a = new CKEDITOR.dom.event(a)), !1 !== e.onkey(e, a.getKeystroke());
          }),
        ...
        if (this.directional)
          a.on(
            ...
            function (b) {
              ...
              d.setAttribute(
                'style',
                CKEDITOR.skin.getIconStyle(n, 'rtl' == b, this.icon, this.iconOffset)
              );
            },
            this
          );
  ...
  (function () {
    function D(a) {
      function d() {
        for (
          var b = f(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || v(a), n = 0;
          n < e.length;
          n++
        ) {
          var g = e[n];
          ...
          (d = b[e]),
            ...
            '/' == d
              ...
              : CKEDITOR.tools.isArray(d)
                ...
                : d.items && (c(h, CKEDITOR.tools.clone(d.items)), (h.name = d.name), a.push(h));
        return a;
      }
                      ...
                      if (t.type == CKEDITOR.UI_SEPARATOR) k = e && t;
                        ...
                        if (!m) {
                          ...
                          b.push(
                            '\x3cspan id\x3d"',
                            r,
                            '" class\x3d"cke_toolbar' + (v ? ' cke_toolbar_last"' : '"'),
                        ...
                        A
                          ? e ||
                            (b.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'),
                            (e = 1))
  ...
  (function () {
    function u(a, b, c) {
      b.type || (b.type = 'auto');
      if ((c && !1 === a.fire('beforePaste', b)) || (!b.dataValue && b.dataTransfer.isEmpty()))
        return !1;
    ...
    function x(a) {
        ...
        if (CKEDITOR.plugins.clipboard.isCustomCopyCutSupported) {
          var c = function (b) {
            a.getSelection().isCollapsed() ||
              ((a.readOnly && 'cut' == b.name) || m.initPasteDataTransfer(b, a),
              b.data.preventDefault());
          };
          b.on('copy', c);
          b.on('cut', c);
        ...
        return {
          ...
          exec: function (a, b) {
            function c(b, h) {
              ...
              b
                ? ((b.method = 'paste'),
                  b.dataTransfer || (b.dataTransfer = m.initPasteDataTransfer()),
                  u(a, b, h))
                : e &&
                  !a._.forcePasteDialog &&
                  a.showNotification(p, 'info', a.config.clipboard_notificationDuration);
              ...
              p =
                'string' === typeof e
                  ...
                  : a.lang.clipboard.pasteNotification.replace(
                      /%1/,
                      '\x3ckbd aria-label\x3d"' + f.aria + '"\x3e' + f.display + '\x3c/kbd\x3e'
                    ),
      ...
      function n(b, c) {
        ...
        if (!d.getById('cke_pastebin')) {
          ...
          var k = new CKEDITOR.dom.element(
            (!CKEDITOR.env.webkit && !e.is('body')) || CKEDITOR.env.ie ? 'div' : 'body',
            d
          );
          ...
          (g = k.getParent().isReadOnly())
            ? (k.setOpacity(0), k.setAttribute('contenteditable', !0))
            : k.setStyle('ltr' == a.config.contentsLangDirection ? 'left' : 'right', '-10000px');
      ...
      function k(b) {
        ...
        e && m.canClipboardApiBeTrusted(c.dataTransfer, a)
          ? (b.data.preventDefault(),
            setTimeout(function () {
              u(a, c);
            }, 0))
          : n(b, function (b) {
              c.dataValue = b.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/gi, '');
              e && u(a, c);
            });
      }
      function q() {
      ...
      function t(b) {
        var c = a.getSelection(),
          c = c && c.getRanges()[0];
        if ((a.readOnly || (c && c.checkReadOnly())) && b in { paste: 1, cut: 1 })
      ...
      (function () {
        function b(c, e, d, h, f) {
          ...
          a.addMenuItems &&
            a.addMenuItem(e, { label: p, command: e, group: 'clipboard', order: f });
        }
      ...
      a.getClipboardData = function (b, c) {
        ...
        !1 === r() &&
          ...
          a._.forcePasteDialog && h && a.fire('pasteDialog')
    ...
    function z(a, b) {
      function c(a) {
        return (
          CKEDITOR.tools.repeat('\x3c/p\x3e\x3cp\x3e', ~~(a / 2)) + (1 == a % 2 ? '\x3cbr\x3e' : '')
        );
      }
      b = b
        .replace(/(?!\u3000)\s+/g, ' ')
          ...
          return 'plain-text' == d
            ...
            : 'semantic-content' == d
              ? ((d = c.semanticContent) ||
                  ...
                  d.allow({ $1: { elements: b(), attributes: !0, styles: !1, classes: !1 } }),
    ...
    function A(a, b) {
      a.enterMode == CKEDITOR.ENTER_BR
        ? (b = b
            ...
            .replace(/<\/?p>/g, ''))
        : a.enterMode == CKEDITOR.ENTER_DIV && (b = b.replace(/<(\/)?p>/g, '\x3c$1div\x3e'));
      return b;
    }
    function C(a) {
      a.data.preventDefault();
        ...
        e.attachListener(
          ...
          function () {
            ...
            CKEDITOR.env.ie &&
              ...
              ((b.dragStartContainerChildCount = c ? g(c.startContainer) : null),
          ...
          function (e) {
            if ((e = e.data)) {
              ...
              g.getTransferType(a) == CKEDITOR.DATA_TRANSFER_INTERNAL
                ...
                : g.getTransferType(a) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS
                  ? c(f, h, g)
                  : d(h, g);
            }
          },
      ...
      init: function (a) {
        ...
        a.config.forcePasteAsPlainText
          ...
          : a.config.pasteFilter
            ...
            : !CKEDITOR.env.webkit || 'pasteFilter' in a.config || (c = 'semantic-content');
          ...
          a.on(
            ...
            function (c) {
              ...
              if (
                ...
                'paste' == d.method &&
                b(n) &&
                ((n = n.getFile(0)), -1 != CKEDITOR.tools.indexOf(f, n.type))
              ) {
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      canClipboardApiBeTrusted: function (a, b) {
        return a.getTransferType(b) != CKEDITOR.DATA_TRANSFER_EXTERNAL ||
          ...
          (CKEDITOR.env.gecko && (a.getData('text/html') || a.getFilesCount())) ||
          (CKEDITOR.env.safari && 603 <= CKEDITOR.env.version && !CKEDITOR.env.iOS) ||
          (CKEDITOR.env.iOS && 605 <= CKEDITOR.env.version) ||
      ...
      fixSplitNodesAfterDrop: function (a, b, c, d) {
        ...
        'number' == typeof d &&
          ...
          (f(a.startContainer, g, c) || f(a.endContainer, g, d));
      },
      isDropRangeAffectedByDragRange: function (a, b) {
        var c = b.startContainer,
          d = b.endOffset;
        return (a.endContainer.equals(c) && a.endOffset <= d) ||
          (a.startContainer.getParent().equals(c) && a.startContainer.getIndex() < d) ||
          (a.endContainer.getParent().equals(c) && a.endContainer.getIndex() < d)
          ? !0
          : !1;
      },
      internalDrop: function (a, b, c, d) {
        ...
        h = f.startNode;
        b &&
          a.getPosition(h) & CKEDITOR.POSITION_PRECEDING &&
          b.getPosition(h) & CKEDITOR.POSITION_FOLLOWING &&
          h.insertBefore(a);
        a = d.createRange();
        a.moveToBookmark(e);
      ...
      getRangeAtDropPosition: function (a, b) {
        ...
        if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, f))
          (c = b.document.$.caretRangeFromPoint(d, f)),
            e.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset),
            e.collapse(!0);
        else if (c.rangeParent)
          e.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), e.collapse(!0);
        else {
            ...
            try {
              ...
              if (h) {
                ...
                var t = b.document.$.elementFromPoint(d, f),
                  ...
                  u;
                if (m.equals(b.editable()) || 'html' == m.getName())
                  return g && g.startContainer && !g.startContainer.equals(b.editable()) ? g : null;
                u = m.getClientRect();
                d < u.left
      ...
      initPasteDataTransfer: function (a, b) {
        ...
        return new this.dataTransfer(
          (CKEDITOR.env.edge && a && a.data.$ && a.data.$.clipboardData) || null,
          b
        );
      },
    ...
    CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
      ...
      setData: function (a, b) {
        a = this._.normalizeType(a);
        'text/html' == a
          ? ((this._.data[a] = this._stripHtml(b)), (this._.nativeHtmlCache = b))
          : (this._.data[a] = b);
        if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || 'URL' == a || 'Text' == a)
          if (
            ('Text' == l && 'Text' == a && (this.id = b), this._.fallbackDataTransfer.isRequired())
          )
      ...
      _stripHtml: function (a) {
        function b(a) {
          ...
          b.parse(a);
          return 'number' !== typeof f || 'number' !== typeof g
            ? a
            : a.substring(f, g).replace(/<\/body\s*>$/gi, '');
        }
        a &&
          a.length &&
          ((a = b(a)),
    ...
    CKEDITOR.plugins.clipboard.fallbackDataTransfer.prototype = {
      ...
      _getFallbackTypeContent: function () {
        ...
        a ||
          (a = this._extractDataComment(this._getData(this._customDataFallbackType, !0)).content);
        return a;
      },
      ...
      _extractDataComment: function (a) {
        ...
        if (a && 16 < a.length) {
          ...
          (c = /\x3c!--cke-data:(.*?)--\x3e/g.exec(a)) &&
            c[1] &&
            ((b.data = JSON.parse(decodeURIComponent(c[1]))), (b.content = a.replace(c[0], '')));
        }
        return b;
      },
      _applyDataComment: function (a, b) {
        ...
        b &&
          ...
          (c = '\x3c!--cke-data:' + encodeURIComponent(JSON.stringify(b)) + '--\x3e');
    ...
    CKEDITOR.plugins.enterkey = {
      enterBlock: function (a, e, b, l) {
        function n(a) {
          ...
          if (
            a === CKEDITOR.ENTER_BR ||
            -1 === CKEDITOR.tools.indexOf(['td', 'th'], p.lastElement.getName()) ||
        ...
        if ((b = b || y(a))) {
          ...
          if (c && f && k) {
            ...
            if (c.is('li') || c.getParent().is('li')) {
              ...
              if (d.is('li'))
                b || h
                  ? (b && h && f.remove(), c[h ? 'insertAfter' : 'insertBefore'](d))
                  : c.breakParent(d);
              else {
                if (a)
                  if (
                    (p.block.is('li')
                      ? ((d = g.createElement(e == CKEDITOR.ENTER_P ? 'p' : 'div')),
          ...
          if ((q = b.splitBlock(m))) {
            ...
            k = q.wasEndOfBlock;
            c
              ? ((h = c.getParent()), h.is('li') && (c.breakParent(h), c.move(c.getNext(), 1)))
              : a &&
                (h = a.getParent()) &&
                h.is('li') &&
                (a.breakParent(h),
        ...
        t = (function () {
          ...
          return function (d) {
            if ((k = a.editable())) {
              ...
              m
                ? (q + r <= c.top ? e('top') : q + r > h.height - c.bottom ? e('pin') : e('bottom'),
                  (d = h.width / 2),
                    ...
                    : ((f =
                        'left' == d
                          ...
                          : c.right < h.width
                            ? h.width - c.right
                            : 0),
                      f + n.width > h.width && ((d = 'left' == d ? 'right' : 'left'), (f = 0))),
                  b.setStyle(
                    d,
                    w(('pin' == m ? u : p) + f + ('pin' == m ? 0 : 'left' == d ? v : -v))
                  ))
                : ((m = 'pin'), e('pin'), t(d));
            }
          };
      ...
      init: function (a) {
        ...
        a.addMode('wysiwyg', function (e) {
          function b(b) {
            ...
            a.isDestroyed() ||
              a.isDetached() ||
              (a.editable(new l(a, d.$.contentWindow.document.body)), a.setData(a.getData(1), e));
          }
          var c =
              'document.open();' +
              (CKEDITOR.env.ie ? '(' + CKEDITOR.tools.fixDomain + ')();' : '') +
          ...
          if (h) {
            var g = CKEDITOR.tools.getNextId(),
              k = CKEDITOR.dom.element.createFromHtml(
                '\x3cspan id\x3d"' + g + '" class\x3d"cke_voice_label"\x3e' + h + '\x3c/span\x3e'
              );
            c.append(k, 1);
          ...
          if (e) this.setHtml(a), this.fixInitialSelection(), b.fire('dataReady');
            ...
            d
              ? (/<body[\s|>]/.test(a) || (a = '\x3cbody\x3e' + a),
                ...
                /<head[\s|>]/.test(a)
                  ? /<title[\s|>]/.test(a) ||
                    (a = a.replace(/<head[^>]*>/, '$\x26\x3ctitle\x3e\x3c/title\x3e'))
                  : (a = a.replace(
                      /<html[^>]*>/,
          ...
          for (var n = new CKEDITOR.dom.walker(f), c; (c = n.next()); )
            if (c.type == CKEDITOR.NODE_ELEMENT)
              if (!c.equals(l) && c.getDirection())
                ...
                if (d)
                  for (
                    var g = 'ltr' == b.data.dir ? ['_rtl', ''] : ['', '_rtl'], h = 0;
                    h < d.length;
                    h++
                  )
                    c.hasClass(d[h] + g[0]) &&
    ...
    function w(f) {
      function g(b) {
        ...
        if (!k.isIndent) {
          ...
          if ((t = b.getParent()) && t.is('li'))
            for (var d = e.listNode.getChildren(), r = [], l, a = d.count() - 1; 0 <= a; a--)
      ...
      for (
        ...
        b &&
          ...
          ((d = new CKEDITOR.dom.walker(c)), (d.evaluator = n), (c.startContainer = d.next()));
        b &&
          c.endContainer.type == CKEDITOR.NODE_ELEMENT &&
          c.endContainer.getName() in p &&
          ((d = new CKEDITOR.dom.walker(c)), (d.evaluator = n), (c.endContainer = d.previous()));
        if (b) return g(b);
      }
      return 0;
    }
          ...
          f.on(
            ...
            function (g) {
              ...
              if ('wysiwyg' == f.mode && g.data.keyCode == this.indentKey && c) {
                ...
                !m ||
                  (this.isIndent &&
                    CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, m)) ||
      ...
      return {
        elements: {
          $: function (a) {
            ...
            if (
              (c = (c = c && new CKEDITOR.htmlParser.fragment.fromHtml(d)) && c.children[0]) &&
  ...
  (function () {
    ...
    CKEDITOR.plugins.add('link', {
      ...
      onLoad: function () {
        ...
        var b =
            'background:url(' +
            CKEDITOR.getUrl(
              this.path + 'images' + (CKEDITOR.env.hidpi ? '/hidpi' : '') + '/anchor.png'
            ) +
      ...
      init: function (c) {
        ...
        c.addCommand(
          'link',
          new CKEDITOR.dialogCommand('link', { allowedContent: b, requiredContent: 'a[href]' })
        );
        c.addCommand(
          'anchor',
        ...
        c.on(
          ...
          function (a) {
            ...
            b &&
              ...
              (b.is('a')
                ? ((a.data.dialog =
                    !b.getAttribute('name') || (b.getAttribute('href') && b.getChildCount())
                      ? 'link'
                      : 'anchor'),
                  (a.data.link = b))
          ...
          b.push(function (a, b) {
            if (
              ...
              (CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, a) ||
                (a.getAttribute('name') && (!a.getAttribute('href') || !a.getChildCount())))
            )
              return 'anchor';
          });
      },
    ...
    CKEDITOR.plugins.link = {
      ...
      parseLinkAttributes: function (c, b) {
        ...
        if (!d.type)
          if ((f = a.match(x)))
            (d.type = 'anchor'), (d.anchor = {}), (d.anchor.name = d.anchor.id = f[1]);
            ...
            a &&
              (g = a.match(y)) &&
              ((d.type = 'url'), (d.url = {}), (d.url.protocol = g[1]), (d.url.url = g[2]));
        if (b) {
          if ((a = b.getAttribute('target')))
            ...
            for (d.target = { type: 'popup', name: a[1] }; (f = D.exec(a[2])); )
              ('yes' != f[2] && '1' != f[2]) || f[1] in { height: 1, width: 1, top: 1, left: 1 }
          ...
          case 'email':
            ...
            switch (a) {
              ...
              case 'encode':
                ...
                'encode' == a
                  ? ((a = ["javascript:void(location.href\x3d'mailto:'+", q(f)]),
                    d && a.push("+'", p(d), "'"),
                    a.push(')'))
                  : (a = ['mailto:', f, d]);
                break;
      ...
      showDisplayTextForElement: function (c, b) {
        var a = {
          ...
          e = b.getSelection();
        return (b.widgets && b.widgets.focused) || (e && 1 < e.getRanges().length)
          ? !1
          : !c || !c.getName || !c.is(a);
      },
    };
      ...
      exec: function (c) {
        if (CKEDITOR.env.ie) {
          var b = c.getSelection().getRanges()[0],
            a =
              (b.getPreviousEditableNode() && b.getPreviousEditableNode().getAscendant('a', !0)) ||
    ...
    CKEDITOR.removeAnchorCommand.prototype = {
      exec: function (c) {
        ...
        if (
          ...
          (e.getChildCount() ? e.is('a') : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, e))
        )
          e.remove(1);
  ...
  (function () {
    function K(a, l, d, f) {
      ...
      for (var m, e = d.listNode.getChildCount(), b = 0; b < e && (m = d.listNode.getChild(b)); b++)
      ...
      if (!(1 > g.length)) {
        ...
        for (d.push(b); g.length; )
          (d = g.shift()),
            ...
            (c = d),
            c.is('pre') || M.test(c.getName()) || 'false' == c.getAttribute('contenteditable')
              ? d.appendTo(a)
              : (d.copyAttributes(a),
                h && d.getDirection() && (a.removeStyle('direction'), a.removeAttribute('dir')),
                d.moveChildren(a),
                d.remove()),
            a.appendTo(b);
      ...
      function f(b) {
        if (
          !(
            ...
            !(p = l.root[b ? 'getPrevious' : 'getNext'](CKEDITOR.dom.walker.invisible(!0))) ||
    ...
    function F(a, l, d, f) {
      for (var e, g; (e = a[f ? 'getLast' : 'getFirst'](O)); )
        (g = e.getDirection(1)) !== l.getDirection(1) && e.setAttribute('dir', g),
          e.remove(),
    ...
    function D(a, l, d) {
      ...
      for (; d.checkStartOfBlock() && d.checkEndOfBlock(); ) {
        ...
        if (!f) break;
        f.is('li') &&
          ((g = f.getParent()), f.equals(g.getLast(t)) && f.equals(g.getFirst(t)) && (f = g));
            ...
            for (var c = 0, p = h.getChildCount(), m; c < p; c++)
              (m = h.getChild(c)),
                m.type == CKEDITOR.NODE_ELEMENT && u[m.getName()]
                  ? CKEDITOR.plugins.list.listToArray(m, l, d, f + 1, k.grandparent)
                  : k.contents.push(m);
          }
        }
        return d;
        ...
        for (
          ...
          if (q.indent == p) {
            (k && a[c].parent.getName() == k.getName()) ||
              ((k = a[c].parent.clone(!1, 1)), e && k.setAttribute('dir', e), h.append(k));
            ...
            (q = a[c - 1].element.getDirection(1)),
              (c = CKEDITOR.plugins.list.arrayToList(a, null, c, f, q != n ? n : null)),
              !m.getChildCount() &&
                CKEDITOR.env.needsNbspFiller &&
                7 >= b.$.documentMode &&
            ...
            u[g.getName()]
              ? ((m = q.element.clone(!1, !0)), n != g.getDirection(1) && m.setAttribute('dir', n))
            ...
            for (g = 0; g < z; g++)
              if (((v = q.contents[g]), I(v) && 1 < z))
                ...
                A &&
                  r.setAttribute(
                    'style',
                    A.replace(/([^;])$/, '$1;') + (r.getAttribute('style') || '')
                  );
                B && v.addClass(B);
                r = null;
                x && (m.append(x), (x = null));
                ...
                J
                  ? (r || ((r = b.createElement(y)), m.append(r), k && r.setAttribute('dir', n)),
    ...
    C.prototype = {
      exec: function (a) {
        ...
        for (
          var e = g.createBookmarks(!0), h = [], c = {}, b = b.createIterator(), p = 0;
          (k = b.getNextRange()) && ++p;
              ...
              for (
                ...
                if (u[q.getName()] && y.contains(q)) {
                  ...
                  (n = q.getCustomData('list_group_object'))
                    ...
                    : ((n = { root: q, contents: [m] }),
                      h.push(n),
                      CKEDITOR.dom.element.setMarker(c, q, 'list_group_object', n));
                  r = 1;
                  break;
                }
              r ||
                ...
                r.getCustomData('list_group_object_' + p)
                  ...
                  : ((n = { root: r, contents: [m] }),
                    CKEDITOR.dom.element.setMarker(c, r, 'list_group_object_' + p, n),
                    h.push(n)));
            }
        }
        for (q = []; 0 < h.length; )
          (n = h.shift()),
            this.state == CKEDITOR.TRISTATE_OFF
              ? l(n) || (u[n.root.getName()] ? K.call(this, a, n, c, q) : L.call(this, a, n, q))
      ...
      refresh: function (a, l) {
        ...
        d && f.contains(d)
          ? this.setState(d.is(this.type) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF)
          : this.setState(CKEDITOR.TRISTATE_OFF);
      },
    };
              ...
              if (e && e.collapsed) {
                ...
                if (b) {
                  ...
                  (c = A(c))
                    ? ((f = c),
                      (c = c.getPrevious(t)),
                      d.moveToPosition(c && z(c) ? c : f, CKEDITOR.POSITION_BEFORE_START))
                    : (k.range.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
                      ...
                      (c = k.previous()) &&
                        ...
                        d.moveToPosition(d.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                  ...
                  if (
                    ...
                    2 == g &&
                      (d.moveToPosition(d.endPath().block, CKEDITOR.POSITION_BEFORE_END),
                      e.endPath().block &&
                        e.moveToPosition(e.endPath().block, CKEDITOR.POSITION_AFTER_START));
                    D(a, d, e);
                    l.cancel();
                  }
                } else
                  k.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END),
                    (c = k.next()) &&
                      ...
                      g.block && e.checkStartOfBlock() && e.checkEndOfBlock()
                        ? (g.block.remove(), e.moveToElementEditStart(c), e.select())
                        : A(c)
                          ? (e.moveToElementEditStart(c), e.select())
                          : ((e = e.clone()), e.moveToElementEditStart(c), D(a, d, e)),
                      l.cancel());
                setTimeout(function () {
                  a.selectionChange(1);
                });
      ...
      init: function (d) {
        function e(a) {
          var b = new CKEDITOR.dom.element('a'),
            c = a.replace(/"/g, '%22'),
            c = c.match(CKEDITOR.config.autolink_urlRegex) ? c : 'mailto:' + c;
          b.setText(a);
          b.setAttribute('href', c);
          a = CKEDITOR.plugins.link.parseLinkAttributes(d, b);
          a = CKEDITOR.plugins.link.getLinkAttributes(d, a);
          CKEDITOR.tools.isEmpty(a.set) || b.setAttributes(a.set);
          a.removed.length && b.removeAttributes(a.removed);
          b.removeAttribute('data-cke-saved-href');
          return b.getOuterHtml();
        }
        function g(a, b) {
          var c = a.slice(0, b).split(/\s+/);
          return (c = c[c.length - 1]) && f(c) ? { start: a.lastIndexOf(c), end: b } : null;
        }
        function f(a) {
          return a.match(d.config.autolink_urlRegex) || a.match(d.config.autolink_emailRegex);
        }
        this.isSupportedEnvironment() &&
          (d.on('paste', function (a) {
            if (a.data.dataTransfer.getTransferType(d) != CKEDITOR.DATA_TRANSFER_INTERNAL) {
              var b = a.data.dataValue;
              -1 < b.indexOf('\x3c') ||
                !f(b) ||
                ((a.data.dataValue = e(b)), (a.data.type = 'html'));
            }
          }),
          d.on('key', function (a) {
            if (
              'wysiwyg' === d.mode &&
              -1 != CKEDITOR.tools.indexOf(d.config.autolink_commitKeystrokes, a.data.keyCode)
            ) {
              var b = CKEDITOR.plugins.textMatch.match(d.getSelection().getRanges()[0], g);
              if (
                b &&
                ((a = d.getSelection()),
                !a.getRanges()[0].startContainer.getAscendant('a', !0) &&
                  (a.selectRanges([b.range]),
                  d.insertHtml(e(b.text), 'text'),
                  !CKEDITOR.env.webkit))
              ) {
                var b = a.getRanges()[0],
                  c = d.createRange();
                c.setStartAfter(b.startContainer);
                a.selectRanges([c]);
              }
            }
          }));
  ...
  (function () {
    function h(a) {
      function m() {
        ...
        d = CKEDITOR.env.quirks ? e.getBody() : e.getDocumentElement();
        var c = CKEDITOR.env.quirks ? d : d.findOne('body');
        c &&
          (c.setStyle('height', 'auto'),
          c.setStyle('min-height', CKEDITOR.env.safari ? '0%' : 'auto'));
      ...
      function g() {
        k && d.setStyle('overflow-y', 'hidden');
        var c = a.window.getViewPaneSize().height,
          b;
        n.append(f);
        ...
        b != c &&
          l != b &&
          ((b = a.fire('autoGrow', { currentHeight: c, newHeight: b }).newHeight),
          (c = 'border-box' === a.container.getComputedStyle('box-sizing')),
          (c = a.container.getSize('width', c)),
          a.resize(c, b, !0),
          (l = b));
        k ||
          (b < p && d.$.scrollHeight > d.$.clientHeight
            ? d.setStyle('overflow-y', 'hidden')
            : d.removeStyle('overflow-y'));
      }
      var l,
        e,
        n,
      ...
      a.on('afterCommandExec', function (a) {
        'maximize' == a.data.name &&
          ...
          (a.data.command.state == CKEDITOR.TRISTATE_ON ? d.removeStyle('overflow-y') : g());
      });
      a.on('contentDom', m);
      m();
      ...
      exec: function (g) {
        ...
        if (c) {
          ...
          if (a == CKEDITOR.TRISTATE_OFF) {
            ...
            1 > e.length &&
              ((a = g.document.createElement(g.config.enterMode == CKEDITOR.ENTER_P ? 'p' : 'div')),
              (b = h.shift()),
              c.insertNode(a),
              ...
              for (c = !0; a.length; )
                if (((f = a.shift()), 'div' == f.getName())) {
                  ...
                  for (
                    c =
                      f.getNext() &&
                      !(f.getNext().type == CKEDITOR.NODE_ELEMENT && f.getNext().isBlockBoundary());
                    f.getFirst();
            ...
            if (this.isFramed) {
              ...
              a.on(
                ...
                function (a) {
                  ...
                  if ('input' !== a.data.getTarget().getName() || (37 !== b && 39 !== b))
                    this._.onKeyDown && !1 === this._.onKeyDown(b)
                      ? ('input' === a.data.getTarget().getName() && 32 === b) ||
                        a.data.preventDefault()
                      : (27 == b || b == ('rtl' == c ? 39 : 37)) &&
                        this.onEscape &&
                        !1 === this.onEscape(b) &&
    ...
    CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        onKeyDown: function (a, b) {
          ...
          switch (e) {
            case 'next':
              for (var d = this._.focusIndex, e = this._.getItems(), c; (c = e.getItem(++d)); )
            ...
            e.on(
              ...
              function (a) {
                ...
                this.allowBlur() &&
                  ...
                  (CKEDITOR.env.iOS
                    ? this._.hideTimeout ||
                      (this._.hideTimeout = CKEDITOR.tools.setTimeout(u, 0, this))
                    : u.call(this));
              },
              this
            ),
              ...
              var a = CKEDITOR.tools.bind(function () {
                ...
                if (l.autoSize) {
                  var b = l.element.getDocument(),
                    b = (CKEDITOR.env.webkit || CKEDITOR.env.edge ? l.element : b.getBody()).$
                      .scrollWidth;
                  CKEDITOR.env.ie &&
                    CKEDITOR.env.quirks &&
                    0 < b &&
                ...
                q
                  ? m < c && (d = h > c ? d + c : b.width > c ? d - a.left : d - a.right + b.width)
                  : m < c && (d = h > c ? d - c : b.width > c ? d - a.right + b.width : d - a.left);
                c = a.top;
                b.height - a.top < e &&
                  (p = c > e ? p - e : b.height > e ? p - a.bottom + b.height : p - a.top);
                CKEDITOR.env.ie &&
                  !CKEDITOR.env.edge &&
                  ((b = a = k.$.offsetParent && new CKEDITOR.dom.element(k.$.offsetParent)) &&
                    'html' == b.getName() &&
                    (b = b.getDocument().getBody()),
                  b &&
                    'rtl' == b.getComputedStyle('direction') &&
                    (d = CKEDITOR.env.ie8Compat
                      ? d - 2 * k.getDocument().getDocumentElement().$.scrollLeft
      ...
      proto: {
        ...
        show: function (a, b, f, c) {
          ...
          for (
            var d = l.elementPath(),
              d = [
                '\x3cdiv class\x3d"cke_menu' +
                  (d && d.direction() != l.lang.dir ? ' cke_mixed_dir_content' : '') +
                  '" role\x3d"presentation"\x3e',
              ],
              k = h.length,
              n = k && h[0].group,
            ...
            var q = h[p];
            n != q.group &&
              (d.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'),
              (n = q.group));
            q.render(this, p, d);
          }
          d.push('\x3c/div\x3e');
        ...
        findItemByCommandName: function (a) {
          ...
          return b.length
            ? ((b = b[0]), { item: b, element: this._.element.findOne('.' + b.className) })
            : null;
        },
      },
    });
        ...
        render: function (a, b, f) {
          ...
          this.command &&
            ...
            (e = g.getCommandKeystroke(e)) &&
              (d = CKEDITOR.tools.keystrokeToString(g.lang.common.keyboard, e)));
                ...
                if (!f || !b)
                  if ((a.preventDefault(), !e)) {
                    if (CKEDITOR.env.mac && CKEDITOR.env.webkit) {
                      var b = this.editor,
                        c = new CKEDITOR.dom.elementPath(a.getTarget(), b.editable()).contains(
                          function (a) {
  ...
  (function () {
    ...
    CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        createPanel: function (a) {
          if (!this._.panel) {
            ...
            f.onHide = function (b) {
              ...
              d.setState(
                d.modes && d.modes[a.mode] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
              );
              d._.on = 0;
        ...
        commit: function () {
          this._.committed ||
            (this._.list.commit(), (this._.committed = 1), CKEDITOR.ui.fire('ready', this));
          this._.committed = 1;
        },
        setState: function (a) {
          if (this._.state != a) {
    ...
    function m(a) {
      ...
      if (
        ...
        if (f && g) {
          ...
          f || g
            ? c.moveToPosition(a, f ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_END)
            : (c.splitElement(a), c.moveToPosition(a, CKEDITOR.POSITION_AFTER_END)),
  ...
  CKEDITOR.plugins.add('htmlwriter', {
    init: function (b) {
      ...
      a.indentationChars =
        'string' === typeof b.config.dataIndentationChars ? b.config.dataIndentationChars : '\t';
        ...
        if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
          ...
          a.addCommand('maximize', {
            ...
            exec: function () {
              ...
              if ((d = this.uiItems[0]))
                (g =
                  this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize : f.maximize.minimize),
              ...
              'wysiwyg' == a.mode
                ? l
                  ? (CKEDITOR.env.gecko && v(a),
                    ...
                    (k = a.getSelection().getStartElement()) && k.scrollIntoView(!0))
                  : c.$.scrollTo(m.x, m.y)
  ...
  (function () {
      ...
      b.attachListener(
        ...
        function (a) {
          ...
          (b <= this.rect.left ||
            ...
            a >= this.rect.bottom) &&
            this.hideVisible();
          (0 >= b || b >= this.winTopPane.width || 0 >= a || a >= this.winTopPane.height) &&
            this.hideVisible();
        },
        this
      );
      ...
      this.lineTpl = new CKEDITOR.template(
        ...
        tipLeftStyle: CKEDITOR.tools.writeCssText(
          CKEDITOR.tools.extend(
            {},
            q,
            { left: '0px', 'border-left-color': 'red', 'border-width': '6px 0 6px 6px' },
            this.tipCss,
            this.tipLeftStyle,
            !0
          )
        ...
        tipRightStyle: CKEDITOR.tools.writeCssText(
          CKEDITOR.tools.extend(
            {},
            q,
            { right: '0px', 'border-right-color': 'red', 'border-width': '6px 6px 6px 0' },
            this.tipCss,
            this.tipRightStyle,
            !0
          )
    ...
    m.prototype = {
      ...
      store: (function () {
        ...
        return function (d, b) {
          ...
          b & CKEDITOR.LINEUTILS_AFTER &&
            l((c = d.getNext())) &&
            c.isVisible() &&
            (a(c, CKEDITOR.LINEUTILS_BEFORE, this.relations), (b ^= CKEDITOR.LINEUTILS_AFTER));
          b & CKEDITOR.LINEUTILS_INSIDE &&
            l((c = d.getFirst())) &&
            c.isVisible() &&
            (a(c, CKEDITOR.LINEUTILS_BEFORE, this.relations), (b ^= CKEDITOR.LINEUTILS_INSIDE));
      ...
      traverseSearch: function (a) {
        ...
        while (
          (!a || a.type != CKEDITOR.NODE_ELEMENT || 'true' != a.getAttribute('contenteditable')) &&
          (a = a.getParent())
        );
      },
          ...
          for (var c in d)
            (b = d[c]),
              ...
              b.type & CKEDITOR.LINEUTILS_BEFORE &&
                this.store(c, CKEDITOR.LINEUTILS_BEFORE, a(b, CKEDITOR.LINEUTILS_BEFORE)),
              b.type & CKEDITOR.LINEUTILS_AFTER &&
                this.store(c, CKEDITOR.LINEUTILS_AFTER, a(b, CKEDITOR.LINEUTILS_AFTER)),
    ...
    p.prototype = {
      ...
      getStyle: function (a, d) {
        ...
        this.inline
          ...
          : (0 < b.elementRect.left
            ...
            0 < (b = e.left + e.width - (this.rect.left + this.winPane.width)) && (e.width -= b));
      ...
      cleanup: function () {
        ...
        for (d in this.visible)
          (a = this.visible[d]), a.getCustomData('hash') !== this.hash && this.hideLine(a);
      },
  ...
  (function () {
    ...
    CKEDITOR.plugins.widgetselection = {
      ...
      addFillers: function (a) {
        ...
        if (!this.isWholeContentSelected(a) && 0 < a.getChildCount()) {
          ...
          d &&
            d.type == CKEDITOR.NODE_ELEMENT &&
            !d.isEditable() &&
            ((this.startFiller = this.createFiller()), a.append(this.startFiller, 1));
          c &&
            c.type == CKEDITOR.NODE_ELEMENT &&
            !c.isEditable() &&
            ((this.endFiller = this.createFiller(!0)), a.append(this.endFiller, 0));
          if (this.hasFiller(a))
            return (b = b.createRange()), b.selectNodeContents(a), b.select(), !0;
        }
        return !1;
      },
      ...
      cleanPasteData: function (a) {
        a &&
          a.length &&
          (a = a.replace(this.createFillerRegex(), '').replace(this.createFillerRegex(!0), ''));
        return a;
      },
        ...
        if (a) {
          ...
          g && 0 < g.length && g != this.fillerContent
            ? (b.insertHtmlIntoRange(g, d.getSelection().getRanges()[0]),
              f.setStartAt(b.getChild(b.getChildCount() - 1), CKEDITOR.POSITION_BEFORE_END),
              d.getSelection().selectRanges([f]))
            : e &&
              (c
                ? f.setStartAt(b.getFirst().getNext(), CKEDITOR.POSITION_AFTER_START)
                : f.setEndAt(b.getLast().getPrevious(), CKEDITOR.POSITION_BEFORE_END),
  ...
  (function () {
    ...
    function h(a, b, c, d, e) {
      ...
      CKEDITOR.tools.extend(
        ...
        d,
        {
          ...
          _: {
            downcastFn:
              d.downcast && 'string' == typeof d.downcast ? d.downcasts[d.downcast] : d.downcast,
          },
        },
        !0
      );
    ...
    function t(a, b, c) {
      ...
      CKEDITOR.dtd[this.getName()].p
        ? ((this.enterMode = b ? b.getAllowedEnterMode(a.enterMode) : a.enterMode),
            ...
            for (k = 0; k < n; ++k)
              if (((f = c[k]), (l = {}), (g = f[0](a, l))))
                return (
                  ...
                  (a.attributes['data-cke-widget-data'] = encodeURIComponent(JSON.stringify(l))),
                ...
                : 8 == c || 46 == c
                  ? ((e = d.editor.getSelection().getRanges()),
                    ...
                    (e = !(
                      1 == e.length &&
                      d.collapsed &&
                      d.checkBoundaryOfElement(b, CKEDITOR[8 == c ? 'START' : 'END'])
                    )))
                  : (e = void 0));
          return e;
        },
    ...
    function T(a) {
      ...
      e.on('selectionChange', function (b) {
        var c =
            (b = h.getNestedEditable(e.editable(), b.data.selection.getStartElement())) &&
            a.getByElement(b),
          d = a.widgetHoldingFocusedEditable;
        d
          ? (d === c && d.focusedEditable.equals(b)) || (p(a, d, null), c && b && p(a, c, b))
          : c && b && p(a, c, b);
      });
          ...
          b.data.dataValue.forEach(
            function (b) {
              ...
              if ('data-cke-widget-white-space' in c) {
                ...
                e.parent.attributes['data-cke-white-space-last'] &&
                  (e.value = e.value.replace(/&nbsp;$/g, ' '));
              }
              if ('data-cke-widget-id' in c) {
                if ((c = a.instances[c['data-cke-widget-id']]))
                  (d = b.getFirst(h.isParserWidgetElement)),
                    f.push({ wrapper: b, element: d, widget: c, editables: {} }),
                    '1' != d.attributes['data-cke-widget-keep-attr'] &&
                      delete d.attributes['data-widget'];
              } else if ('data-cke-widget-editable' in c)
                return (
                  0 < f.length && (f[f.length - 1].editables[c['data-cke-widget-editable']] = b), !1
                );
            },
            CKEDITOR.NODE_ELEMENT,
            !0
        ...
        function (a) {
          if (a.data.downcastingSessionId)
            for (var b = c[a.data.downcastingSessionId], f, g, l, k, h, m; (f = b.shift()); ) {
              ...
              a.data.widgetsCopy &&
                g.getClipboardHtml &&
                ((k = CKEDITOR.htmlParser.fragment.fromHtml(g.getClipboardHtml())),
                (k = k.children[0]));
    ...
    function Q(a) {
      ...
      b.on('dataReady', function () {
        if (d)
          for (
            var c = b.editable().find('.cke_widget_wrapper'), f, g, l = 0, k = c.count();
            l < k;
            ++l
          )
            (f = c.getItem(l)),
        ...
        commit: function () {
          ...
          for (f && (g = a.focused) && x(a, g); (g = d.pop()); )
            b.splice(CKEDITOR.tools.indexOf(b, g), 1),
              g.isInited() &&
                ((l = g.editor.checkDirty()), g.setSelected(!1), !l && g.editor.resetDirty());
          f &&
            e &&
      ...
      u.hasCopyBin(a) ||
        ((e = new u(a, {
          ...
          afterDestroy: function () {
            b &&
              !a.readOnly &&
              (c ? a.widgets.del(c) : a.extractSelectedHtml(), a.fire('saveSnapshot'));
          },
        })),
        c ||
          ((d =
            CKEDITOR.env.webkit &&
            CKEDITOR.plugins.widgetselection.isWholeContentSelected(a.editable())),
    ...
    function ia(a) {
      ...
      a.editables = {};
      if (a.editables)
        for (c in b) (d = b[c]), a.initEditable(c, 'string' == typeof d ? { selector: d } : d);
    }
    function O(a) {
      if (!0 === a.mask) ma(a);
      else if (a.mask) {
    ...
    function na() {
      if (this.wrapper) {
        ...
        if (a && 'string' != typeof a) {
          ...
          if (c.offsetWidth != d.offsetWidth || c.offsetHeight != d.offsetHeight || e)
            (c = a.getParent()),
    ...
    function ja(a) {
      if (a.draggable) {
        ...
        if (!a.inline && (d.on('mousedown', oa, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version))
      ...
      function c(a) {
        ...
        function c(a) {
          function b(a, c) {
            ...
            for (var f in a)
              if (
                ('object' !== typeof a[f] || 'object' !== typeof c[f] || !b(a[f], c[f])) &&
                a[f] !== c[f]
              )
                return !1;
            return !0;
        ...
        for (var n = 0, m = a.group.length; n < m; n++)
          (k = a.group[n]), d[h][k] || (d[h][k] = []), (k = d[h][k]), b(k, c(a)) || k.push(a);
      }
      var d = {};
      CKEDITOR.style.addCustomHandler({
        ...
        checkElement: function (a) {
          return h.isDomWidgetWrapper(a)
            ? (a = a.getFirst(h.isDomWidgetElement)) && a.data('widget') == this.widget
            : !1;
        },
        buildPreview: function (a) {
    ...
    q.prototype = {
      ...
      initOnAll: function (a) {
        ...
        for (var b = [], c, d = a.count(); d--; )
          (c = this.initOn(a.getItem(d).getFirst(h.isDomWidgetElement))) && b.push(c);
        return b;
      },
      onWidget: function (a) {
      ...
      wrapElement: function (a, b) {
        ...
        if (a instanceof CKEDITOR.dom.element) {
          ...
          'data-cke-widget-keep-attr' in a.attributes ||
            (a.attributes['data-cke-widget-keep-attr'] = a.attributes['data-widget'] ? 1 : 0);
    ...
    h.prototype = {
      ...
      initEditable: function (a, b) {
        ...
        return c && c.is(CKEDITOR.dtd.$editable)
          ? ((c = new t(this.editor, c, { filter: B.call(this.repository, this.name, a, b) })),
            (this.editables[a] = c),
            c.setAttributes({
            ...
            c.on('focus', M, this),
            CKEDITOR.env.ie && c.on('blur', L, this),
      ...
      _findOneNotNested: function (a) {
        ...
        for (var b, c, d = 0; d < a.count(); d++)
          if (
            ((b = a.getItem(d)), (c = b.getAscendant(h.isDomWidgetWrapper)), this.wrapper.equals(c))
          )
            return b;
        return null;
      },
      ...
      updateDragHandlerPosition: function () {
        ...
        (c && b.x == c.x && b.y == c.y) ||
          ((c = a.checkDirty()),
          a.fire('lockSnapshot'),
          this.dragHandlerContainer.setStyles({ top: b.y + 'px', left: b.x + 'px' }),
  ...
  (function () {
    CKEDITOR.plugins.add('oembed', {
      ...
      init: function (e) {
        ...
        function p(a, d, c, f, g, k, l, b, h) {
          if ('' === h) return alert(e.lang.oembed.titleError), !1;
          jQuery('body').oembed(a, {
            onEmbed: function (d) {
              var g = jQuery.fn.oembed.getOEmbedProvider(a);
              b.element.data('resizeType', k);
              if ('responsive' == k || 'custom' == k)
                b.element.data('maxWidth', c), b.element.data('maxHeight', f);
              '' !== h && b.element.data('title', h);
              b.element.data('align', l);
              'center' == l
                ? (b.inline || b.element.setStyle('text-align', 'center'),
                  b.element.removeStyle('float'))
                : (b.inline || b.element.removeStyle('text-align'),
                  'none' == l ? b.element.removeStyle('float') : b.element.setStyle('float', l));
              if ('string' === typeof d.code) {
                for (; b.element.$.firstChild; ) b.element.$.removeChild(b.element.$.firstChild);
                b.element.appendHtml(m(g.name, d.code, c, f));
                b.element.data('oembed', a);
                b.element.data('oembed_provider', g.name);
                b.element.addClass('oembed-provider-' + g.name);
              } else if ('string' === typeof d.code[0].outerHTML) {
                for (; b.element.$.firstChild; ) b.element.$.removeChild(b.element.$.firstChild);
                b.element.appendHtml(m(g.name, d.code[0].outerHTML, c, f));
                b.element.data('oembed', a);
                b.element.data('oembed_provider', g.name);
                b.element.addClass('oembed-provider-' + g.name);
              } else alert(e.lang.oembed.noEmbedCode);
            },
            onError: function (a) {
              0 < a.indexOf('vimeo.com')
                ? alert(e.lang.oembed.noVimeo)
                : alert(e.lang.oembed.Error);
            },
            afterEmbed: function () {
              e.fire('change');
            },
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
          oEmbed: function (a, d, c, f) {
            function g() {
              if (null == d || 'undefined' == d) d = null;
              if (null == c || 'undefined' == c) c = null;
              if (null == f || 'undefined' == f) f = !1;
              p(a, e, !1, d, c, f);
            }
            if (1 > a.length || 0 > a.indexOf('http')) return alert(e.lang.oembed.invalidUrl), !1;
            'undefined' === typeof jQuery.fn.oembed
              ? CKEDITOR.scriptLoader.load(
                  CKEDITOR.getUrl(CKEDITOR.plugins.getPath('oembed') + 'libs/jquery.oembed.min.js'),
                  function () {
        ...
        e.widgets.add('oembed', {
          ...
          allowedContent: {
            div: {
              ...
              attributes: '*',
              classes:
                null != e.config.oembed_WrapperClass
                  ? e.config.oembed_WrapperClass
                  : 'embeddedContent',
            },
            'div(embeddedContent,oembed-provider-*) iframe': { attributes: '*' },
            'div(embeddedContent,oembed-provider-*) blockquote': { attributes: '*' },
            'div(embeddedContent,oembed-provider-*) embed': { attributes: '*' },
          },
          template:
            '\x3cdiv class\x3d"' +
            (null != e.config.oembed_WrapperClass
          ...
          init: function () {
            ...
            this.setData(a);
            this.element.addClass('oembed-provider-' + a.oembed_provider);
            this.on(
              'dialog',
              function (a) {
                a.data.widget = this;
        ...
        e.ui.addButton('oembed', {
          label: e.lang.oembed.button,
          command: 'oembed',
          toolbar: 'insert,10',
        });
        var q = function () {
          var a = this.getDialog(),
            d = this.getValue(),
            c = a.getContentElement('general', 'maxSizeBox').getElement(),
        ...
        CKEDITOR.dialog.add('oembed', function (a) {
          return {
            ...
            onShow: function () {
              ...
              this.widget.setData(a);
              this.getContentElement('general', 'resizeType').setValue(a.resizeType);
              this.getContentElement('general', 'align').setValue(a.align);
              var a = this.getContentElement('general', 'resizeType').getValue(),
                c = this.getContentElement('general', 'maxSizeBox').getElement(),
                f = this.getContentElement('general', 'sizeBox').getElement();
              'noresize' == a
                ? (c.hide(), f.hide())
                : 'custom' == a
                  ? (c.hide(), f.show())
                ...
                elements: [
                  {
                    ...
                    id: 'oembedHeader',
                    html:
                      '\x3cdiv style\x3d"white-space:normal;width:500px;padding-bottom:10px"\x3e' +
                      a.lang.oembed.pasteUrl +
                      '\x3c/div\x3e',
                  },
                  {
                    type: 'text',
                    ...
                    label: a.lang.oembed.embedTitle,
                    setup: function (a) {
                      a.data.title && this.setValue(a.data.title);
                    },
                  },
                  {
                    type: 'text',
                    ...
                    commit: function (d) {
                      var c = CKEDITOR.dialog.getCurrent(),
                        f = c.getValueOf('general', 'embedTitle'),
                        e = c.getValueOf('general', 'embedCode').replace(/\s/g, ''),
                        k = c.getContentElement('general', 'resizeType').getValue(),
                        l = c.getContentElement('general', 'align').getValue(),
                        b = null,
                        h = null,
                        n = !1,
                        m = c.getParentEditor();
                      if (1 > e.length || 0 > e.indexOf('http'))
                        return alert(a.lang.oembed.invalidUrl), !1;
                      'noresize' == k
                        ? ((n = !1), (h = b = null))
                        : 'responsive' == k
                          ? ((b = c
                      ...
                      d.setData('title', f);
                      d.setData('oembed', e);
                      d.setData('resizeType', k);
                      d.setData('align', l);
                      d.setData('maxWidth', b);
                      d.setData('maxHeight', h);
                    },
                  },
                  {
                    type: 'hbox',
                    ...
                    children: [
                      {
                        ...
                        default: 'noresize',
                        setup: function (a) {
                          a.data.resizeType && this.setValue(a.data.resizeType);
                        },
                        items: [
                        ...
                        children: [
                          {
                            ...
                            id: 'maxWidth',
                            default:
                              null != a.config.oembed_maxWidth ? a.config.oembed_maxWidth : '560',
                            label: a.lang.oembed.maxWidth,
                            title: a.lang.oembed.maxWidthTitle,
                            setup: function (a) {
                              a.data.maxWidth && this.setValue(a.data.maxWidth);
                            },
                          },
                          {
                            type: 'text',
                            ...
                            width: '120px',
                            default:
                              null != a.config.oembed_maxHeight ? a.config.oembed_maxHeight : '315',
                            label: a.lang.oembed.maxHeight,
                            title: a.lang.oembed.maxHeightTitle,
                            setup: function (a) {
                              a.data.maxHeight && this.setValue(a.data.maxHeight);
                            },
                          },
                        ],
                      },
  ...
  (function () {
    function g(a) {
      var d = a.listenerData && a.listenerData.editor,
        b = a.data.$.clipboardData,
        c = !1,
        e = /^image/;
      if (b)
        return Array.prototype.forEach.call(b.types, function (a, f) {
          if (!c && (a.match(e) || b.items[f].type.match(e))) return h(b.items[f], d), (c = !0);
        });
    }
    function h(a, d) {
      if (a && 'function' === typeof a.getAsFile) {
        var b = a.getAsFile(),
          c = new FileReader();
        c.onload = function (a) {
          var b = d.document.createElement('img', { attributes: { src: a.target.result } });
          setTimeout(function () {
            d.insertElement(b);
          }, 10);
        };
    ...
    CKEDITOR.plugins.add('pastebase64', {
      init: function (a) {
        a.addFeature && a.addFeature({ allowedContent: 'img[alt,id,!src]{width,height};' });
        a.on('contentDom', function () {
          (a.editable ? a.editable() : a.document).on('paste', g, null, { editor: a });
        });
      },
    });
  })();
          ...
          if ((a = a.data.styles)) {
            for (var b, f, d, g = 0, n = a.length; g < n; g++)
              ...
              (c.blockless && b.element in CKEDITOR.dtd.$block) ||
                ('string' == typeof b.type && !CKEDITOR.style.customHandlers[b.type]) ||
                ((f = b.name),
                ...
                (b._.weight =
                  g + 1e3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3)),
                (e[f] = b),
                k.push(b),
                m.push(b));
            k.sort(function (a, b) {
          ...
          init: function () {
            ...
            for (e = k.length; g < e; g++)
              (a = k[g]),
                ...
                this.add(b, a.type == CKEDITOR.STYLE_OBJECT ? b : a.buildPreview(), b);
            this.commit();
          },
          onClick: function (a) {
            c.focus();
    ...
    init: function (a) {
      function f(c) {
        return CKEDITOR.tools.extend(c || {}, {
          ...
          refresh: function (c, b) {
            this.setState(
              b.contains('table', 1) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
            );
          },
        });
      }
      if (!a.blockless) {
        ...
        a.ui.addButton &&
          a.ui.addButton('Table', { label: e.toolbar, command: 'table', toolbar: 'insert,30' });
  ...
  (function () {
    function q(d, f) {
      ...
      function c(a) {
        ...
        0 < e.length ||
          ...
          (CKEDITOR.dom.element.setMarker(h, a, 'selected_cell', !0), e.push(a));
      }
      var e = [],
        h = {};
      if (!d) return e;
      for (var a = d.getRanges(), k = 0; k < a.length; k++) {
        var g = a[k];
        if (g.collapsed)
          (g = g.getCommonAncestor().getAscendant({ td: 1, th: 1 }, !0)) && b(g) && e.push(g);
        else {
          var g = new CKEDITOR.dom.walker(g),
            m;
          for (g.guard = c; (m = g.next()); )
            (m.type == CKEDITOR.NODE_ELEMENT && m.is(CKEDITOR.dtd.table)) ||
              ((m = m.getAscendant({ td: 1, th: 1 }, !0)) &&
                ...
                b(m) &&
                (CKEDITOR.dom.element.setMarker(h, m, 'selected_cell', !0), e.push(m)));
        }
      }
    ...
    function B(d) {
      ...
      d instanceof CKEDITOR.dom.element &&
        ((c = d.getAscendant('table')), 1 == c.$.rows.length ? c.remove() : d.remove());
      return null;
    }
    function v(d) {
    ...
    function y(d) {
      ...
      m.length == d &&
        (b[0].moveToPosition(c, CKEDITOR.POSITION_AFTER_END), b[0].select(), c.remove());
      return k;
    }
    function t(d, f) {
    ...
    function z(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        ...
        a: {
          ...
          (h = h.getPrevious())
            ? (e = h.getLast())
            : ((h = b[e].getParent()), (e = (h = h.getNext()) ? h.getChild(0) : null));
        }
        d.reset();
        ...
        e
          ? p(e, !0)
          : c &&
            (f[0].moveToPosition(c, CKEDITOR.POSITION_BEFORE_START), f[0].select(), c.remove());
      } else
        d instanceof CKEDITOR.dom.element &&
          ((f = d.getParent()), 1 == f.getChildCount() ? f.remove() : d.remove());
    }
    function p(d, f) {
      var b = d.getDocument(),
        c = CKEDITOR.document;
    ...
    function x(d, f, b) {
      ...
      if (
        ...
        ((e = d.getCommonAncestor()) && e.type == CKEDITOR.NODE_ELEMENT && e.is('table'))
      )
        return !1;
      d = c[0];
    ...
    function C(d, f) {
      ...
      if (1 < g) {
        ...
        for (
          g = m = 1, e = c.clone(), e.insertAfter(c), e.append((c = b.clone())), l = A(h, a), k = 0;
          k < l.length;
          k++
        )
          l[k].rowSpan++;
      ...
      init: function (d) {
        function f(a) {
          return CKEDITOR.tools.extend(a || {}, {
            ...
            refresh: function (a, b) {
              this.setState(
                b.contains({ td: 1, th: 1 }, 1) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
              );
            },
          });
        }
  ...
  CKEDITOR.tools.buildTableMap = function (q, r, B, v, w) {
    ...
    for (r = r || 0; r <= v; r++) {
      ...
      for (var t = -1, z = B; z <= (-1 === w ? q[r].cells.length - 1 : w); z++) {
        ...
        for (t++; y[u][t]; ) t++;
        for (
          var A = isNaN(p.colSpan) ? 1 : p.colSpan, p = isNaN(p.rowSpan) ? 1 : p.rowSpan, x = 0;
          x < p && !(r + x > v);
          x++
        ) {
          y[u + x] || (y[u + x] = []);
  ...
  (function () {
        ...
        for (
          ...
          u
            ? ((q = u.getDocumentPosition().x),
              l ? (p = q + u.$.offsetWidth - t(u, 'right')) : (v = q + t(u, 'left')))
            : ((q = b.getDocumentPosition().x), l ? (p = q) : (v = q + b.$.offsetWidth));
          k = Math.max(v - p, 3);
    ...
    function E(b) {
      ...
      function a() {
        for (var d = f.rtl, l = d ? p.length : u.length, a = 0, e = 0; e < l; e++) {
          var g = u[e],
            h = p[e],
            c = f.table;
          CKEDITOR.tools.setTimeout(
            ...
            0,
            this,
            [g, g && z(g), h, h && z(h), (!g || !h) && z(c) + t(c, 'left') + t(c, 'right'), m]
          );
        }
      }
      function l(l) {
        ...
        for (
          ...
          (w && r && w.equals(r)) ||
            (w && (n = Math.min(n, z(w))), r && (t = Math.min(t, z(r))), c.push(w), k.push(r));
        }
        u = c;
        p = k;
        v = f.x - n;
      ...
      k = this.move = function (b, a) {
        if (!f) return 0;
        if (!(y || (b >= f.x && b <= f.x + f.width && a >= f.y && a <= f.y + f.height)))
          return (
            (f = null),
            (y = m = 0),
          ...
          a.attachListener(a.isInline() ? a : b.document, 'mousemove', function (a) {
            ...
            if (e.type == CKEDITOR.NODE_ELEMENT) {
              var h = a.getPageOffset().x,
                f = a.getPageOffset().y;
              if (c && c.move(h, f)) B(a);
              else if (e.is('table') || e.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }, 1))
                if (((a = e.getAscendant('table', 1)), b.editable().contains(a))) {
                  ...
                  a: {
                    ...
                    for (var e = 0, g = a.length; e < g; e++) {
                      var d = a[e];
                      if (h >= d.x && h <= d.x + d.width && f >= d.y && f <= d.y + d.height) {
                        h = d;
                        break a;
                      }
                    }
        ...
        : function (b, c) {
            function a() {
              ...
              f.getById('preview') ||
                ...
                f.write(
                  '\x3c!DOCTYPE html\x3e\x3chtml\x3e\x3chead\x3e\x3cmeta charset\x3d"utf-8"\x3e' +
                    '\x3cscript src\x3d"' +
                    c.config.mathJaxLib +
                    '"\x3e\x3c/script\x3e' +
                    '\x3cscript\x3e\n' +
                    '/*MathJax.Hub.Config( {showMathMenu: false,messageStyle: "none"} );*/\n' +
                    "function getCKE() {if ( typeof window.parent.CKEDITOR \x3d\x3d 'object' ) {return window.parent.CKEDITOR;} else {return window.parent.parent.CKEDITOR;}}\n" +
                    'function update() {MathJax.typesetPromise([this.buffer]).then((e) => getCKE().tools.callFunction( ' +
                    n +
                    ' ));}\n' +
                    'MathJax.startup.promise = MathJax.startup.promise.then(() => getCKE().tools.callFunction(' +
                    p +
                    '));\n' +
                    '\x3c/script\x3e' +
                    '\x3c/head\x3e\x3cbody style\x3d"padding:0;margin:0;background:transparent;overflow:hidden"\x3e\x3cspan id\x3d"preview"\x3e\x3c/span\x3e\x3cspan id\x3d"buffer" style\x3d"display:none"\x3e\x3c/span\x3e\x3c/body\x3e\x3c/html\x3e'
                ));
            }
            function e() {
              m = !0;
  ...
  CKEDITOR.config.plugins =
    'dialogui,dialog,about,basicstyles,notification,button,toolbar,clipboard,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo,a11yhelp,textmatch,autolink,autogrow,blockquote,panel,floatpanel,menu,contextmenu,listblock,richcombo,font,format,horizontalrule,htmlwriter,liststyle,maximize,lineutils,widgetselection,widget,oembed,pastebase64,specialchar,stylescombo,table,tabletools,tableresize,indentblock,mathjax';
