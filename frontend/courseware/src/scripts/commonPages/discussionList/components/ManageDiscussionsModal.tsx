...
interface ManageDiscussionsModalProps {
  translate: (key: string, args?: any) => string;
  discussions: any;
  isModalOpen: boolean;
  closedSavingState: any;
  toggleModal: () => void;
  closeModal: () => void;
  saveUpdates: (discussions: any, state: ManageDiscussionsModalState) => void;
}

interface ManageDiscussionsModalState {
  closed: Record<string, boolean>;
}

class ManageDiscussionsModal extends Component<
  ManageDiscussionsModalProps,
  ManageDiscussionsModalState
> {
  state: ManageDiscussionsModalState = {
    closed: {},
  };

  toggleClosed = (discussion: any) => {
    this.setState({
      closed: {
        ...this.state.closed,
