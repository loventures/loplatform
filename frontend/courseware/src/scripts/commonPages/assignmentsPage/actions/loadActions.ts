...
const assignmentDetailsLoader = (viewingAs: any, rows: any) => {
...
const assignmentDetailsSuccessAC = ({ viewingAs, overviews }: { viewingAs: any; overviews: any }) => {
...
export const loadAssignmentDetailsActionCreator = (getState: () => CourseState) => {
