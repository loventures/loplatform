...
export const getCanGoStatus = (currentIndex: number, questionTuples: any[], settings: any) =>
...
export const getIndexToGoAfter = (
  currentIndex: number,
...
export const getInitialQuestionIndex = (questionTuples: any[]) => {
...
export const getShouldDisplaySkip = (settings: any) => {
  switch (settings.assessmentNavigationPolicy) {
    case QUIZ_NAVIGATION_REQUIRE_ANSWER:
    case QUIZ_NAVIGATION_ENFORCE_LINEAR:
      return true;
