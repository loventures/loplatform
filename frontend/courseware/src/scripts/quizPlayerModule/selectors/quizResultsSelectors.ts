...
export const quizResultsSelectorCreator = (quiz: any, attemptId: any) => {
  ...
  return createSelector([settingsSelector, attemptSelector], (settings: any, attempt: any) => {
    return {
      settings,
      attempt,
...
export const quizViewQuestionsSelectorCreator = (quiz: any) => {
  const quizResultsSelector = quizQuestionsSelectorCreator(quiz.contentId);

  return createSelector([quizResultsSelector], (quizResults: any) => {
    return {
      ...quizResults,
    };
  });
