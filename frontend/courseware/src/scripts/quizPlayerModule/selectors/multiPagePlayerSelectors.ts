...
export const multiPagePlayerStateSelector = (quizId: any, attemptId: any) => {
  ...
  return createSelector(
    ...
    (settings: any, { questionTuples }: any, playerState: any = {}) => {
...
export const multiPagePlayerSelectorCreator = (quiz: any, attemptId: any) => {
  ...
  return createSelector(
    ...
    (
      { questionTuples }: any,
      playerState: any,
      unsavedChangesState: any,
      { unansweredQuestions }: any,
      timeStamps: any,
      questionSubmissionState: any = {},
      quizSubmissionState: any = {},
      settings: any
    ) => {
      // `currentQuestionTuple` is `{}` until the attempt's player state is initialized (currentQuestionIndex
      // is unset on the first render before `enterQuizPlayer` lands), so optional-chain its nested derefs.
