...
export const singlePagePlayerUnansweredQuestionsSelector = (attemptId: any) => {
  ...
  return createSelector(
    ...
    ({ allUnsavedChanges }: any, { questionTuples }: any) => {
      const unansweredQuestions = filter(questionTuples, (tuple: any) => {
...
export const singlePagePlayerSelectorCreator = (quiz: any, attemptId: any) => {
