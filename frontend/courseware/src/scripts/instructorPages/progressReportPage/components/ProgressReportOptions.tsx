...
interface ProgressReportOptionsProps {
  listState: {
    activeOptions: {
      sortKey: string;
      searchString: string;
  ...
  searchAction: (searchString: string, searchConfig: any) => void;
  sortAction: (sortConfig: any) => void;
}
