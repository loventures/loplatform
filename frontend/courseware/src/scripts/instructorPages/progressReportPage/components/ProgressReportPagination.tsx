...
interface ProgressReportPaginationProps extends WithTranslateProps {
  listState: {
    activeOptions: {
      pageSize: number;
      totalPages: number;
  ...
  paginateAction: (pageNumber: number) => void;
}

const ProgressReportPagination = ({
  translate,
  listState,
  setPageSize,
  paginateAction,
}: ProgressReportPaginationProps) => (
