...
interface ProgressReportBreadcrumbsProps {
  breadcrumbs: any[];
}

const ProgressReportBreadcrumbs = ({ breadcrumbs }: ProgressReportBreadcrumbsProps) => (
...
export default connect(selectProgressReportBreadcrumbsComponent)(
