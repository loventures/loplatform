...
interface OverviewModalProps {
  ...
  loadingState: any;
  modalState: any;
  toggleModal: (activeOverview?: any) => void;
  sendMessage: (contentId: any, activeOverview: any, grade: any, message: any) => void;
}

interface OverviewModalState {
  grade: any;
  message: string;
}

class OverviewModal extends Component<OverviewModalProps, OverviewModalState> {
  state: OverviewModalState = {
    grade: null,
    message: '',
  };

  gradeChanged = (grade: any) => {
    this.setState({ grade });
  };
...
export default connect(selectOverviewModalComponent as any, {
  toggleModal: toggleSendMessageModalActionCreator,
  sendMessage: sendMessageActionCreator,
})(withTranslation(OverviewModal)) as React.ComponentType<any>;
