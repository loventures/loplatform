...
const AssessmentOverviewLoader = createLoaderComponent(
  selectActivityOverviewLoaderComponent as any,
  (({ contentId }: any) => loadActivityOverviewActionCreator(contentId)) as any,
  'AssessmentOverviewLoader'
);

const OverviewListHeader = withTranslation(({ translate, title, icon }: any) => (
...
const ERActivityOverviewPage = ({ translate, content, ...props }: any) => (
