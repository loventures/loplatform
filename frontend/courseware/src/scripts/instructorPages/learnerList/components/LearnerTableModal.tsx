...
interface LearnerTableModalProps {
  translate: (key: string, params?: any) => string;
  isModalOpen: boolean;
  learner: any;
  messageState: any;
  toggleModal: () => void;
  sendMessage: (learner: any, message: string) => void;
  messageRestarted: () => void;
}

interface LearnerTableModalState {
  message: string;
}

class LearnerTableModal extends Component<LearnerTableModalProps, LearnerTableModalState> {
  state: LearnerTableModalState = {
    message: '',
  };

  messageChanged = (event: React.ChangeEvent<HTMLInputElement>) => {
