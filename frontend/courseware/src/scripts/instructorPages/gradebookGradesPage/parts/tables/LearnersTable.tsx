...
interface LearnersTableProps extends WithTranslateProps {
  learners: any[];
            ...
            >
              ...
              <span>
                <a
                  ...
                  target="_blank"
                  href={gradebookAPI.downloadStudentGrades(courseId, learner.id)}
                >
...
export default connect(selectGradebookLearners as any)(
  withTranslation(LearnersTable)
) as any;
