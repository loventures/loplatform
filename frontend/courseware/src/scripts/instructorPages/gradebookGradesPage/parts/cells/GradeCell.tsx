...
interface GradeCellProps extends WithTranslateProps {
  grade: any;
...
const GradeCellTranslated = withTranslation(GradeCell);

const GradeCellWithEditing = (props: any) => {
...
export default connect(
  (
    state: any,
    { learnerId, contentId, percentFormat }: { learnerId: string; contentId: string; percentFormat?: boolean }
  ) => {
