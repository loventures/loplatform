...
interface GradebookTableControlsProps extends WithTranslateProps {
  listState: any;
  sort: (sortConfig: any) => void;
  search: (searchString: string, searchConfig?: any) => void;
  showExternalIds: boolean;
  showForCreditOnly: boolean;
  gradeDisplayMethod: string;
  toggleShowExternalIds: () => void;
  toggleShowForCreditOnly: () => void;
  setGradeDisplayMethod: (method: string) => void;
}
