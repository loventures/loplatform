...
interface TableCollapsedButtonProps {
  numInGroup: number;
  expandTables: () => void;
}

// forwardRef so react-transition-group can target the <button> via nodeRef
// (findDOMNode was removed in React 19).
const TableCollapsedButton = forwardRef<HTMLButtonElement, TableCollapsedButtonProps>(
  function TableCollapsedButton({ numInGroup, expandTables }, ref) {
...
export default TableCollapsedButton;
