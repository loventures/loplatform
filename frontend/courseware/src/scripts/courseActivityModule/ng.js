...
import CompetencyBreakdownService from '../services/CompetencyBreakdownService.js';
import GradingService from '../services/GradingService.js';
import SubmissionActivityAPI from '../services/SubmissionActivityAPI.js';

export default angular.module('lof.courseActivityModule', [
  ProgressService.name,
  QuizAPI.name,
  CompetencyBreakdownService.name,
  GradingService.name,
