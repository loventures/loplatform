...
import { DiscussionBoard } from '../../../discussion/directives/discussionBoard.tsx';
import Tutorial from '../../../tutorial/Tutorial.js';
import { get } from 'lodash';
import { RubricGrid } from '../../../assignmentGrade/directives/rubricGrid/rubricGrid.tsx';
import { GraderJumpButton } from '../../../assignmentGrader/jumper/graderJumpButtonLight.tsx';
...
const getHasBlockInstructions = (content: any) => {
...
class DiscussionActivity extends React.Component<DiscussionActivityProps> {
  componentDidMount() {
    this.props.onLoaded?.();
  }
      ...
      <div className="discussion-activity">
        ...
        {viewingAs.id !== actualUser.id && content.hasGradebookEntry && (
          <div className="flex-center-center p-3">
            <GraderJumpButton content={content} />
          </div>
        )}
...
const DiscussionActivityContainer = (props: any) => (
