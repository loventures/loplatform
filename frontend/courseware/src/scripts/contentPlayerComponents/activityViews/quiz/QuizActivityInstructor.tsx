...
import { ContentQuizQuestionsLoader } from '../../../contentPlayerDirectives/quizLoaders/ContentQuizQuestionsLoader.tsx';
...
interface QuizActivityInstructorProps {
  content: any;
  viewingAs: any;
  printView?: boolean;
  quiz: any;
...
const QuizActivityInstructor = ({
  content,
  viewingAs,
  printView,
  quiz,
  onLoaded,
}: QuizActivityInstructorProps) => (
