...
import { ContentQuizPlayerLoader } from '../../../../contentPlayerDirectives/quizLoaders/ContentQuizPlayerLoader.tsx';
...
interface QuizActivityPlayAttemptProps {
  content: any;
  viewingAs: any;
  printView?: boolean;
  quiz: any;
