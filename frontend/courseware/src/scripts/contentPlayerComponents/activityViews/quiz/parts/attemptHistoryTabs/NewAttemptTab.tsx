...
const TrialLearnerReadOnlyText = ({ translate }: WithTranslateProps) => (
  <span className="flex-col-fluid text-right">{translate('ASSESSMENT_READ_ONLY_STATUS')}</span>
);

interface AttemptsRemainingTextProps extends WithTranslateProps {
...
interface NewAttemptTabProps extends WithTranslateProps {
  attemptsRemaining: number;
  unlimitedAttempts: boolean;
  isReadOnly: boolean;
  viewingAs: any;
