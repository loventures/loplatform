...
const SummaryCount = (label: string, count: number, classNames?: string) => (
  <div className={classNames}>
    {count} {label}
  </div>
);

const SpecificSummaryRow = ({
  summary = {},
  viewingAs,
  translate,
}: {
...
const StatsBox = ({ summary = {}, translate }: { summary?: any; translate: Translate }) => (
