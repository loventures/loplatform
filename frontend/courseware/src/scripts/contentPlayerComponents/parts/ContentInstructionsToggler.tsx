...
interface ContentInstructionsTogglerProps {
  translate: Translate;
...
interface ContentInstructionsTogglerState {
  showInstructions: boolean;
}

class ContentInstructionsToggler extends React.Component<
  ContentInstructionsTogglerProps,
  ContentInstructionsTogglerState
> {
  constructor(props: ContentInstructionsTogglerProps, ...args: any[]) {
    super(props, ...(args as []));
    this.state = {
