...
interface ContentLockableContainerProps {
  content: any;
  viewingAs: any;
  viewType?: string;
...
interface ContentLockableContainerState {
  isFlipped: boolean;
  iconHover: boolean;
...
class ContentLockableContainer extends React.Component<
  ContentLockableContainerProps,
  ContentLockableContainerState
> {
  state = {
    isFlipped: false,
    iconHover: false,
  ...
  setIconHover = (show: boolean) => {
    this.setState({ iconHover: show });
  };
  setOverlayHover = (show: boolean) => {
    this.setState({ overlayHover: show });
  };
  setTooltipHover = (show: boolean) => {
