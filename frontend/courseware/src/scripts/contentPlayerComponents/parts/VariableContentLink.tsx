...
import ContentLinkComponent from './ContentLink.js';
const ContentLink: any = ContentLinkComponent;
...
interface VariableContentLinkProps {
  content: any;
  children?: any;
  setProgress?: (content: any, progress: number) => void;
  [key: string]: any;
}

const VariableContentLink = ({
  content,
  children,
  setProgress,
  ...props
}: VariableContentLinkProps) => {
...
})(VariableContentLink as any) as any;
