...
export const getProgressLabel = (translate: Translate, content: any, viewingAs?: any) => {
...
export const getGradeLabel = (translate: Translate, content: any, viewingAs?: any) => {
  return content.grade
    ? translate('CONTENT_GRADE_OVERALL', { grade: gradeFilter(content.grade) })
    : translate('CONTENT_GRADE_NO_SCORE');
};

export const getDueDateLabel = (translate: Translate, content: any, viewingAs?: any) => {
  if (!content.dueDate) {
    return '';
  }
...
export const getLockInfoLabel = (translate: Translate, content: any, viewingAs?: any) => {
...
export const summarizeToLabel = (translate: Translate, content: any, viewingAs: any) => {
