...
interface HorseshoeGraphicProps {
  correct: number;
  incorrect: number;
}

class HorseshoeGraphic extends PureComponent<HorseshoeGraphicProps> {
  render() {
...
interface ScoreHorseshoeProps extends WithTranslateProps {
  correct: number;
  incorrect: number;
  children?: ReactNode;
}

const ScoreHorseshoe = ({ correct, incorrect, children }: ScoreHorseshoeProps) => (
  <div
