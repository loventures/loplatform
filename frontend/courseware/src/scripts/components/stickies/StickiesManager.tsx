...
import { createRef, createContext, Component, PropsWithChildren } from 'react';

export interface StickiesContextValue {
  displays: Record<string, any>;
  refs: Record<string, any>;
  orderedStickies: string[];
  addSticky: (name: string) => () => void;
  removeSticky?: (name: string) => void;
}

export const StickiesContext = createContext<StickiesContextValue>({
  displays: {},
  refs: {},
  orderedStickies: [],
  addSticky: () => () => {},
...
interface StickiesManagerState {
  displays: Record<string, any>;
  refs: Record<string, any>;
  orderedStickies: string[];
  addSticky: (name: string) => () => void;
...
class StickiesManager extends Component<PropsWithChildren, StickiesManagerState> {
  state: StickiesManagerState = {
    displays: {},
    refs: {},
    orderedStickies: [],
    addSticky: name => {
