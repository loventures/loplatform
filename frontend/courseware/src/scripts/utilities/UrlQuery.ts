...
function UrlQuery(this: any, cfg?: any) {
  this.loadQuery(cfg);
}
...
UrlQuery.prototype.page = function () {
  return parseInt((this.offset / this.limit) as any, 10);
};
...
*/
var getDirection = function (order: any) {
  if (isNaN(order)) {
    return order;
  } else {
...
UrlQuery.prototype.switchDirection = function (props, startNew) {
  ...
  if (!props) {
    props = cloneDeep(this.orderPriority);
  }
  ...
  var isMostRecentOrder = every(
    props,
    function (this: any, prop: any, index: any) {
...
UrlQuery.prototype.setOrder = function (prop, order) {
  if (!order && Array.isArray(prop)) {
    ...
    this.setOrder((prop as any).property, (prop as any).order);
    return this;
  }
...
var removeFilter = function (query: any, filter: any, prop: any, op: any, val: any) {
  if (!query[filter]) {
    return;
...
var addFilter = function (query: any, filter: any, prop: any, op: any, val: any) {
 ...
 */
var setFilter = function (pre?: any, unset?: any) {
  var filter = pre ? 'prefilter' : 'filter';

  return function (this: any, prop?: any, op?: any, val?: any) {
    if (unset) {
 ...
 */
var setFilters = function (pre?: any, unset?: any) {
  var fn = setFilter(pre, unset);

  return function (this: any, filters?: any) {
    each(
      filters,
      function (this: any, filter: any) {
...
UrlQuery.prototype.loadQuery = function (cfg) {
  ...
  each(
    cfg,
    function (this: any, value: any, prop: any) {
