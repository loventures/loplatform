...
export const wrapMath = function (html: string): string {
  html = replace(html, mathStarMatch, mathStartReplace);
  html = replace(html, mathEndMatch, mathEndReplace);
  return html;
};

export const processMathHtml = function (parentElement: Element): void {
...
export const queueMathTypeset = function (element: Element): void {
