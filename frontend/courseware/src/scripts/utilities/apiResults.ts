...
*/
export const forPartialResults = ({ total, partialResults }: any) => {
  const results: any = partialResults.slice();
...
*/
export const withTransform = (transformFn: (results: any) => any) => (results: any) => {
