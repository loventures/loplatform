...
var b64pad = '=';
export function b64_sha1(a: string): string {
  return rstr2b64(rstr_sha1(str2rstr_utf8(a)));
}
export function rstr_sha1(a: string): string {
  return binb2rstr(binb_sha1(rstr2binb(a), a.length * 8));
}
export function rstr_hmac_sha1(c: string, f: string): string {
  var e = rstr2binb(c);
  if (e.length > 16) {
...
export function rstr2b64(c: string): string {
  try {
    b64pad;
  } catch (h) {
    b64pad = '';
...
export function str2rstr_utf8(c: string): string {
  var b = '';
  var d = -1;
  var a, e;
  while (++d < c.length) {
...
export function rstr2binb(b: string): any {
...
export function binb2rstr(b: any): string {
  var a = '';
...
export function binb_sha1(v: any, o: any): any {
  v[o >> 5] |= 128 << (24 - (o % 32));
  v[(((o + 64) >> 9) << 4) + 15] = o;
  var y = Array(80);
  var u = 1732584193;
...
export function sha1_ft(e: any, a: any, g: any, f: any): any {
  if (e < 20) {
    return (a & g) | (~a & f);
  }
  if (e < 40) {
...
export function sha1_kt(a: any): any {
  return a < 20 ? 1518500249 : a < 40 ? 1859775393 : a < 60 ? -1894007588 : -899497514;
}
export function safe_add(a: any, d: any): any {
  var c = (a & 65535) + (d & 65535);
  var b = (a >> 16) + (d >> 16) + (c >> 16);
  return (b << 16) | (c & 65535);
}
export function bit_rol(a: any, b: any): any {
  return (a << b) | (a >>> (32 - b));
}
