...
import { cloneDeep, each, isArray, isObject, isString, union } from 'lodash';
...
interface SanityType {
  ...
  dateKeys: string[];
  addDateKeys: (keys: string[]) => void;
  dates: (ref: any, format?: string, lookup?: Record<string, boolean>, recurse?: boolean) => any;
  stringifyDates: (src: any, format?: string) => any;
}

const Sanity = {} as SanityType;
...
Sanity.dates = function (ref, format, lookup) {
  ...
  var m = null;
  var form = null;
  each(ref, function (val: any, key: any) {
