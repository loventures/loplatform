...
export const buildBasicScore = (pointsPossible: any, pointsAwarded: any) => {
  return {
...
export const buildRubricScore = (pointsPossible: any, rubric: any) => {
  return {
...
export const buildBasicFeedback = (comment: any, feedbackManager: any) => {
  return {
...
export const buildRubricFeedback = (rubric: any) => {
...
export const buildAllFeedback = (comment: any, feedbackManager: any, rubric: any) => {
  let feedback: any[] = [];
...
export const getBasicResponseFeedback = ({
  feedback = [],
  attachmentInfos = [],
}: {
  feedback?: any[];
...
export const getRubricResponse = (
  { score, feedback }: { score?: any; feedback?: any },
  rubric: any
) => {
...
export const buildScorableAttemptState = (attempt: any, userInfo: any) => {
  const requiresInstructorInput =
    attempt.state === ATTEMPT_OPEN
      ? true
      : findIndex(userInfo.gradeableAttempts, (attemptId: any) => attemptId === attempt.id) != -1;
  return {
