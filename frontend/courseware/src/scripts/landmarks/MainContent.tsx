...
import { createContext, createRef, Component, ReactNode, RefObject } from 'react';

import { withErrorBoundary } from '../directives/BasicErrorBoundary';

export const MainContentRefContext = createContext<RefObject<HTMLDivElement>>(createRef());
