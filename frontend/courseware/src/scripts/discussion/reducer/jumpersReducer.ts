...
const jumperReducer = (jumper: any = defaultJumperState, action: any) => {
  switch (action.type) {
...
const modifyList = (list: any, add: any, remove: any) =>
  uniq(without(concat(list, map(add, 'id')), ...map(remove, 'id')));

const updatedPostsReducer = (jumper: any, { add, remove }: any) => {
...
const bookmarkedUpdateReducer = (bookmarked: any = defaultJumperState, action: any) => {
...
const jumpersReducer = (jumpers: any = {}, action: any) => {
  switch (action.type) {
    case DISCUSSION_BOARD_JUMPER_SET_JUMPER:
      each(jumpers, (jumper: any, jumperType: any) => {
...
const discussionsJumpersReducer = (discussionsJumpers: any = {}, action: any) => {
  switch (action.type) {
    case DISCUSSION_BOARD_JUMPER_SET_JUMPER:
    case DISCUSSION_BOARD_JUMPER_SET_POST:
    case DISCUSSION_BOARD_JUMPER_SET_USER:
