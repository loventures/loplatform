...
const threadsDataReducer = function (threads: any = {}, action: any) {
  switch (action.type) {
    ...
    case DISCUSSION_POST_VIEWED_AUTO_TOGGLED:
      forEach(action.data, (count: any, threadId: any) => {
        threads = {
          ...threads,
          [threadId]: {
            ...threads[threadId],
    ...
    case DISCUSSION_POST_SET_NOT_NEW:
      forEach(action.data.countByThread, (count: any, threadId: any) => {
        threads = {
          ...threads,
          [threadId]: {
            ...threads[threadId],
