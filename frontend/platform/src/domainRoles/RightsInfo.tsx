...
const RightsInfo: React.FC<RightsInfoProps> = ({ row, T, close }) => {
  ...
  return (
    <Modal
      ...
      size="lg"
    >
      <ModalHeader tag="h2">{T.t('adminPage.roles.rightsModal.rights', row)}</ModalHeader>
      <ModalBody>
        {row.rights.length ? (
          <ListGroup>
