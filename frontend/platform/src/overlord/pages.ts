...
import BannedIps from '../bannedIps/BannedIps';
import Components from '../component';
import Configurations from '../config';
import Connectors from '../connectors/Connectors';
import Domains from '../domains/Domains';
import Gdpr from '../gdpr/GdprPage';
import Jobs from '../jobs';
import Logs from '../logs/Logs';
import MaintenanceWindows from '../maintenanceWindows/MaintenanceWindows';
...
export interface OverlordPage {
  ...
  child?: { identifier: string; Page?: React.ComponentType<any>; name?: string };
}

const pages: OverlordPage[] = [
