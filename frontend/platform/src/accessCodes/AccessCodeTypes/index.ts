...
import { AccessCodeBatchType } from './AccessCodeBatch';
import EnrollAccessCodeBatch from './EnrollAccessCodeBatch';
import IacAccessCodeBatch from './IacAccessCodeBatch';

type AccessCodeTypeEntry = Omit<AccessCodeBatchType, 'id'>;

const AccessCodeTypes: Record<string, AccessCodeTypeEntry> = {
...
export default AccessCodeTypes;
