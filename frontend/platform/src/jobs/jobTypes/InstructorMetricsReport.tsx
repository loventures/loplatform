...
const InstructorMetricsReport: React.FC<JobTypeProps> = ({ T, row, validationErrors }) => {
  const excludeEmailsHelp = <FormText>{T.t('adminPage.jobs.fieldName.excludeEmails.help')}</FormText>;
...
const string2Array = (string: string): string[] => {
