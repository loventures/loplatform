...
const ContentPartTemplateUtils = {
  createHtml: function (
    ...
    each(attributes, function (value: string, name: string) {
  ...
  imageWithCaption: function (asset: any): string {
  ...
  file: function (asset: any): string {
  ...
  image: function (asset: any): string {
