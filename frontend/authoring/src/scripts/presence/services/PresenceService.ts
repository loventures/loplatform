...
import { addAnnouncement, disableAnnouncement } from '../../announcement/AnnouncementActions';
...
type EventStream = SseEventStream | PollingEventStream;
...
class PresenceService {
  ...
  store: typeof dcmStore;
  globalState: any = null;
  presenceState: any = null; // The state in presence reducer
  ...
  listeners: Record<string, Array<(data: any, event?: any) => void>> = {};
  // Current branch
  branchId: number | null = null;
  asset: string | null = null;
  assetField: string | null = null;
  // Current session info
  session: { visible: boolean; millisSinceActive?: number } = {
    visible: false, // Is the user visible to other users
  };

  idleTimerRef: any = null;
  lastActive: number | null = null;

  lastBranchId: number | null = null;
  lastAsset: string | null = null;
  lastAssetField: string | null = null;

  init(idleTimerRef: any) {
    this.store = dcmStore;
   ...
   */
  on = (id: string, callback: (data: any, event?: any) => void, scope?: any) => {
   ...
   */
  start = (o: { branchId: any; visible: boolean }) => {
  ...
  onAssetField = (assetField: string | null, active: boolean) => {
