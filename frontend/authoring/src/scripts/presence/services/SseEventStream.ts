...
class SseEventStream {
  ...
  // The store arg is accepted for parity with PollingEventStream but is unused by SSE.
   ...
   */
  start = ({ handledTypes, presenceId, lastEventId, onError, onEvent }: EventStreamStartOptions) => {
