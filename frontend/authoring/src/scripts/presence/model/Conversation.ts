...
export interface Conversation {
  ...
  localHistory: ConversationMessage[];
}
...
export const newConversation = (room: number, chatOpen: boolean): Conversation => ({
 ...
 */
export const openConversation = (conversation: Conversation): Conversation => ({
  ...conversation,
  chatOpen: true,
  unreadCount: 0,
});
 ...
 * @return the updated conversation
 */
export const closeConversation = (conversation: Conversation): Conversation => ({
  ...conversation,
  chatOpen: false,
});
