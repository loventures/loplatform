...
export const ObservationAssessmentSettings: NarrativeSettings<'observationAssessment.1'> = ({
  asset,
}) => {
  ...
  const scoringOption = asset.data.scoringOption ?? 'mostRecentAttemptScore';
