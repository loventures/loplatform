...
export const PoolAssessmentSettings: NarrativeSettings<'poolAssessment.1'> = ({ asset }) => {
  ...
  const questions = asset.data.useAllQuestions ? 0 : asset.data.numberOfQuestionsForAssessment;
  const scoringOption =
    ...
    <div className="mx-3 mb-2 d-flex justify-content-center">
      <span className="input-padding text-muted text-center feedback-context">
        {sentence(
          ...
          !questions ? 'use all questions' : plural(questions, 'question'),
