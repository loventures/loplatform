...
var createUrl = function createUrl(url: string, parameters: Record<string, any>): string {
...
var constructCredentials = function constructCredentials(
...
var createConfiguration = function createConfiguration(request: any): RequestInit {
...
var JsonRequest = (function () {
   ...
   */
  function JsonRequest(this: any, method, url) {
