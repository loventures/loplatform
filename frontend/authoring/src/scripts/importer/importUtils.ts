...
export const requestQtiImportPreview = (
  file: File,
  branchId: string,
  domainId: number,
  importType: string
...
export const putImportFileInBlobstore = (file: File, fileType: string, domainId: any) => {
...
export const createPreview = (
  typeIdsToSize: Record<string, number>,
  polyglot: Polyglot,
  destination: string,
  itemName: string
) => {
...
export const pollForTaskReport = (
  importReceiptId: string,
  taskReportId: string,
  onEachPoll: (report: any) => void = () => {}
) =>
