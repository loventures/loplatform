...
export const errMessage = (
  { rowNum, err, warn, ...transVars }: Record<string, any>,
  polyglot: Polyglot
): string => {
...
export default withTranslations(connect(mapStateToProps)(TemplateImportModal as any)) as React.ComponentType<any>;
